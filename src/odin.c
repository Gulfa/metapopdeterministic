...
SEXP model_deterministic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 654));
  ...
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->offset_output_beta));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->offset_output_beta_spont_behaviour));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->offset_variable_B_D));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->offset_variable_B_D_H));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->offset_variable_B_D_ICU));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->offset_variable_Ea));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->offset_variable_Es));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->offset_variable_H));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->offset_variable_ICU_H));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->offset_variable_ICU_P));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->offset_variable_ICU_R));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->offset_variable_tot_hosp));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->offset_variable_tot_infected));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->offset_variable_tot_resp));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->offset_variable_tot_vac));
  SET_VECTOR_ELT(contents, 617, ScalarInteger(internal->offset_variable_tot_vac_adm));
  ...
  SET_VECTOR_ELT(contents, 618, p_SE);
  ...
  SET_VECTOR_ELT(contents, 619, pa);
  ...
  SET_VECTOR_ELT(contents, 620, post_icu);
  ...
  SET_VECTOR_ELT(contents, 621, pre_icu);
  SET_VECTOR_ELT(contents, 622, ScalarReal(internal->pre_sympt_infect));
  SET_VECTOR_ELT(contents, 623, ScalarReal(internal->pre_sympt_period));
  ...
  SET_VECTOR_ELT(contents, 624, prob_death_hosp);
  ...
  SET_VECTOR_ELT(contents, 625, prob_death_icu);
  ...
  SET_VECTOR_ELT(contents, 626, prob_death_non_hosp);
  SET_VECTOR_ELT(contents, 627, ScalarReal(internal->rand_beta_days));
  ...
  SET_VECTOR_ELT(contents, 628, spont_behav_change_params);
  ...
  SET_VECTOR_ELT(contents, 629, susceptibility_asymp);
  ...
  SET_VECTOR_ELT(contents, 630, susceptibility_symp);
  ...
  SET_VECTOR_ELT(contents, 631, symp_asymp_effect);
  ...
  SET_VECTOR_ELT(contents, 632, symp_trans);
  ...
  SET_VECTOR_ELT(contents, 633, sympt_frac);
  SET_VECTOR_ELT(contents, 634, ScalarReal(internal->threshold_ini));
  SET_VECTOR_ELT(contents, 635, ScalarReal(internal->threshold_max));
  SET_VECTOR_ELT(contents, 636, ScalarReal(internal->threshold_min));
  SET_VECTOR_ELT(contents, 637, ScalarReal(internal->time_before_death));
  SET_VECTOR_ELT(contents, 638, ScalarReal(internal->time_before_death_hosp));
  SET_VECTOR_ELT(contents, 639, ScalarReal(internal->time_before_death_icu));
  ...
  SET_VECTOR_ELT(contents, 640, tot_hosp_ini);
  ...
  SET_VECTOR_ELT(contents, 641, tot_infected_ini);
  ...
  SET_VECTOR_ELT(contents, 642, tot_resp_ini);
  ...
  SET_VECTOR_ELT(contents, 643, tot_vac_adm_ini);
  ...
  SET_VECTOR_ELT(contents, 644, tot_vac_ini);
  ...
  SET_VECTOR_ELT(contents, 645, transmisibility);
  SET_VECTOR_ELT(contents, 646, ScalarReal(internal->vac_struct_length));
  ...
  SET_VECTOR_ELT(contents, 647, vaccinations);
  ...
  SET_VECTOR_ELT(contents, 648, vax_time_step);
  SET_VECTOR_ELT(contents, 649, ScalarReal(internal->vax_type));
  SET_VECTOR_ELT(contents, 650, ScalarReal(internal->waning_immunity));
  ...
  SET_VECTOR_ELT(contents, 651, waning_immunity_vax);
  SET_VECTOR_ELT(contents, 652, ScalarReal(internal->waning_inf));
  ...
  SET_VECTOR_ELT(contents, 653, waning_tmp);
  SEXP nms = PROTECT(allocVector(STRSXP, 654));
  ...
  SET_STRING_ELT(nms, 597, mkChar("offset_output_beta"));
  SET_STRING_ELT(nms, 598, mkChar("offset_output_beta_spont_behaviour"));
  SET_STRING_ELT(nms, 599, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 600, mkChar("offset_variable_B_D"));
  SET_STRING_ELT(nms, 601, mkChar("offset_variable_B_D_H"));
  SET_STRING_ELT(nms, 602, mkChar("offset_variable_B_D_ICU"));
  SET_STRING_ELT(nms, 603, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 604, mkChar("offset_variable_Ea"));
  SET_STRING_ELT(nms, 605, mkChar("offset_variable_Es"));
  SET_STRING_ELT(nms, 606, mkChar("offset_variable_H"));
  SET_STRING_ELT(nms, 607, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 608, mkChar("offset_variable_ICU_H"));
  SET_STRING_ELT(nms, 609, mkChar("offset_variable_ICU_P"));
  SET_STRING_ELT(nms, 610, mkChar("offset_variable_ICU_R"));
  SET_STRING_ELT(nms, 611, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 612, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 613, mkChar("offset_variable_tot_hosp"));
  SET_STRING_ELT(nms, 614, mkChar("offset_variable_tot_infected"));
  SET_STRING_ELT(nms, 615, mkChar("offset_variable_tot_resp"));
  SET_STRING_ELT(nms, 616, mkChar("offset_variable_tot_vac"));
  SET_STRING_ELT(nms, 617, mkChar("offset_variable_tot_vac_adm"));
  SET_STRING_ELT(nms, 618, mkChar("p_SE"));
  SET_STRING_ELT(nms, 619, mkChar("pa"));
  SET_STRING_ELT(nms, 620, mkChar("post_icu"));
  SET_STRING_ELT(nms, 621, mkChar("pre_icu"));
  SET_STRING_ELT(nms, 622, mkChar("pre_sympt_infect"));
  SET_STRING_ELT(nms, 623, mkChar("pre_sympt_period"));
  SET_STRING_ELT(nms, 624, mkChar("prob_death_hosp"));
  SET_STRING_ELT(nms, 625, mkChar("prob_death_icu"));
  SET_STRING_ELT(nms, 626, mkChar("prob_death_non_hosp"));
  SET_STRING_ELT(nms, 627, mkChar("rand_beta_days"));
  SET_STRING_ELT(nms, 628, mkChar("spont_behav_change_params"));
  SET_STRING_ELT(nms, 629, mkChar("susceptibility_asymp"));
  SET_STRING_ELT(nms, 630, mkChar("susceptibility_symp"));
  SET_STRING_ELT(nms, 631, mkChar("symp_asymp_effect"));
  SET_STRING_ELT(nms, 632, mkChar("symp_trans"));
  SET_STRING_ELT(nms, 633, mkChar("sympt_frac"));
  SET_STRING_ELT(nms, 634, mkChar("threshold_ini"));
  SET_STRING_ELT(nms, 635, mkChar("threshold_max"));
  SET_STRING_ELT(nms, 636, mkChar("threshold_min"));
  SET_STRING_ELT(nms, 637, mkChar("time_before_death"));
  SET_STRING_ELT(nms, 638, mkChar("time_before_death_hosp"));
  SET_STRING_ELT(nms, 639, mkChar("time_before_death_icu"));
  SET_STRING_ELT(nms, 640, mkChar("tot_hosp_ini"));
  SET_STRING_ELT(nms, 641, mkChar("tot_infected_ini"));
  SET_STRING_ELT(nms, 642, mkChar("tot_resp_ini"));
  SET_STRING_ELT(nms, 643, mkChar("tot_vac_adm_ini"));
  SET_STRING_ELT(nms, 644, mkChar("tot_vac_ini"));
  SET_STRING_ELT(nms, 645, mkChar("transmisibility"));
  SET_STRING_ELT(nms, 646, mkChar("vac_struct_length"));
  SET_STRING_ELT(nms, 647, mkChar("vaccinations"));
  SET_STRING_ELT(nms, 648, mkChar("vax_time_step"));
  SET_STRING_ELT(nms, 649, mkChar("vax_type"));
  SET_STRING_ELT(nms, 650, mkChar("waning_immunity"));
  SET_STRING_ELT(nms, 651, mkChar("waning_immunity_vax"));
  SET_STRING_ELT(nms, 652, mkChar("waning_inf"));
  SET_STRING_ELT(nms, 653, mkChar("waning_tmp"));

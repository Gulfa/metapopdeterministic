...
SEXP model_deterministic_create(SEXP user) {
  ...
  internal->dim_spont_behav_change_params = 7;
...
SEXP model_deterministic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 661));
  ...
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_p_SE_1));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_p_SE_12));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_p_SE_2));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_p_SE_3));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_pa));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_pa_1));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_pa_12));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_pa_2));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_pa_3));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_post_icu));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_post_icu_1));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_post_icu_12));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_post_icu_2));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_post_icu_3));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_pre_icu));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_pre_icu_1));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_pre_icu_12));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_pre_icu_2));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_pre_icu_3));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_prob_death_hosp));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_prob_death_hosp_1));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_prob_death_hosp_12));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_prob_death_hosp_2));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_prob_death_hosp_3));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_prob_death_icu));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_prob_death_icu_1));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_prob_death_icu_12));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_prob_death_icu_2));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_prob_death_icu_3));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_prob_death_non_hosp));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_prob_death_non_hosp_1));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_prob_death_non_hosp_12));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_prob_death_non_hosp_2));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_prob_death_non_hosp_3));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_spont_behav_change_params));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_susceptibility_asymp));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_susceptibility_asymp_1));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_susceptibility_asymp_12));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_susceptibility_asymp_2));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_susceptibility_asymp_3));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_susceptibility_symp));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_susceptibility_symp_1));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_susceptibility_symp_12));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_susceptibility_symp_2));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_susceptibility_symp_3));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_symp_asymp_effect));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_symp_asymp_effect_1));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_symp_asymp_effect_12));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_symp_asymp_effect_2));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_symp_asymp_effect_3));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_symp_trans));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_symp_trans_1));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_symp_trans_12));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_symp_trans_2));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_symp_trans_3));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_sympt_frac));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_sympt_frac_1));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_sympt_frac_12));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_sympt_frac_2));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_sympt_frac_3));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_tot_hosp));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_tot_hosp_1));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_tot_hosp_12));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_tot_hosp_2));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_tot_hosp_3));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_tot_hosp_ini));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_tot_hosp_ini_1));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_tot_hosp_ini_12));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_tot_hosp_ini_2));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_tot_hosp_ini_3));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_tot_infected));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_tot_infected_1));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_tot_infected_12));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_tot_infected_2));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_tot_infected_3));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_tot_infected_ini));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_tot_infected_ini_1));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_tot_infected_ini_12));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_tot_infected_ini_2));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_tot_infected_ini_3));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_tot_resp));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_tot_resp_1));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_tot_resp_12));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_tot_resp_2));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_tot_resp_3));
  SET_VECTOR_ELT(contents, 494, ScalarInteger(internal->dim_tot_resp_ini));
  SET_VECTOR_ELT(contents, 495, ScalarInteger(internal->dim_tot_resp_ini_1));
  SET_VECTOR_ELT(contents, 496, ScalarInteger(internal->dim_tot_resp_ini_12));
  SET_VECTOR_ELT(contents, 497, ScalarInteger(internal->dim_tot_resp_ini_2));
  SET_VECTOR_ELT(contents, 498, ScalarInteger(internal->dim_tot_resp_ini_3));
  SET_VECTOR_ELT(contents, 499, ScalarInteger(internal->dim_tot_vac));
  SET_VECTOR_ELT(contents, 500, ScalarInteger(internal->dim_tot_vac_1));
  SET_VECTOR_ELT(contents, 501, ScalarInteger(internal->dim_tot_vac_2));
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->dim_tot_vac_adm));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->dim_tot_vac_adm_1));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->dim_tot_vac_adm_2));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->dim_tot_vac_adm_ini));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->dim_tot_vac_adm_ini_1));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->dim_tot_vac_adm_ini_2));
  SET_VECTOR_ELT(contents, 508, ScalarInteger(internal->dim_tot_vac_ini));
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->dim_tot_vac_ini_1));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->dim_tot_vac_ini_2));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->dim_transmisibility));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->dim_transmisibility_1));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->dim_transmisibility_12));
  SET_VECTOR_ELT(contents, 514, ScalarInteger(internal->dim_transmisibility_2));
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->dim_transmisibility_3));
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_vaccinations));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_vaccinations_1));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_vaccinations_12));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_vaccinations_2));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_vaccinations_3));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_vax_time_step));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_vax_time_step_1));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_vax_time_step_2));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_waning_immunity_vax));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_waning_immunity_vax_1));
  SET_VECTOR_ELT(contents, 526, ScalarInteger(internal->dim_waning_immunity_vax_12));
  SET_VECTOR_ELT(contents, 527, ScalarInteger(internal->dim_waning_immunity_vax_2));
  SET_VECTOR_ELT(contents, 528, ScalarInteger(internal->dim_waning_immunity_vax_3));
  SET_VECTOR_ELT(contents, 529, ScalarInteger(internal->dim_waning_tmp));
  SET_VECTOR_ELT(contents, 530, ScalarInteger(internal->dim_waning_tmp_1));
  SET_VECTOR_ELT(contents, 531, ScalarInteger(internal->dim_waning_tmp_2));
  ...
  SET_VECTOR_ELT(contents, 532, expected_health_loss);
  ...
  SET_VECTOR_ELT(contents, 533, hosp_prob);
  ...
  SET_VECTOR_ELT(contents, 534, icu_prob);
  ...
  SET_VECTOR_ELT(contents, 535, import_vec);
  SET_VECTOR_ELT(contents, 536, ScalarReal(internal->incidence_steps_measurement));
  SET_VECTOR_ELT(contents, 537, ScalarReal(internal->include_waning));
  ...
  SET_VECTOR_ELT(contents, 538, index);
  SET_VECTOR_ELT(contents, 539, ScalarReal(internal->infectious_period));
  ...
  SET_VECTOR_ELT(contents, 540, initial_A);
  ...
  SET_VECTOR_ELT(contents, 541, initial_B_D);
  ...
  SET_VECTOR_ELT(contents, 542, initial_B_D_H);
  ...
  SET_VECTOR_ELT(contents, 543, initial_B_D_ICU);
  ...
  SET_VECTOR_ELT(contents, 544, initial_D);
  ...
  SET_VECTOR_ELT(contents, 545, initial_Ea);
  ...
  SET_VECTOR_ELT(contents, 546, initial_Es);
  ...
  SET_VECTOR_ELT(contents, 547, initial_H);
  ...
  SET_VECTOR_ELT(contents, 548, initial_I);
  ...
  SET_VECTOR_ELT(contents, 549, initial_ICU_H);
  ...
  SET_VECTOR_ELT(contents, 550, initial_ICU_P);
  ...
  SET_VECTOR_ELT(contents, 551, initial_ICU_R);
  ...
  SET_VECTOR_ELT(contents, 552, initial_P);
  ...
  SET_VECTOR_ELT(contents, 553, initial_R);
  ...
  SET_VECTOR_ELT(contents, 554, initial_S);
  ...
  SET_VECTOR_ELT(contents, 555, initial_tot_hosp);
  SET_VECTOR_ELT(contents, 556, ScalarReal(internal->initial_tot_hosp_inc));
  ...
  SET_VECTOR_ELT(contents, 557, initial_tot_infected);
  ...
  SET_VECTOR_ELT(contents, 558, initial_tot_resp);
  ...
  SET_VECTOR_ELT(contents, 559, initial_tot_vac);
  ...
  SET_VECTOR_ELT(contents, 560, initial_tot_vac_adm);
  ...
  SET_VECTOR_ELT(contents, 564, interpolation_time);
  ...
  SET_VECTOR_ELT(contents, 565, kernel);
  ...
  SET_VECTOR_ELT(contents, 566, lambda_ij);
  SET_VECTOR_ELT(contents, 567, ScalarReal(internal->latent_period));
  ...
  SET_VECTOR_ELT(contents, 568, length_hosp);
  ...
  SET_VECTOR_ELT(contents, 569, length_icu);
  SET_VECTOR_ELT(contents, 570, ScalarReal(internal->log_beta_ini));
  ...
  SET_VECTOR_ELT(contents, 571, mixing_matrix);
  SET_VECTOR_ELT(contents, 572, ScalarInteger(internal->n));
  ...
  SET_VECTOR_ELT(contents, 573, n_AR);
  ...
  SET_VECTOR_ELT(contents, 574, n_B_D_D);
  ...
  SET_VECTOR_ELT(contents, 575, n_B_H_D);
  ...
  SET_VECTOR_ELT(contents, 576, n_B_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 577, n_EaA);
  ...
  SET_VECTOR_ELT(contents, 578, n_EsI);
  ...
  SET_VECTOR_ELT(contents, 579, n_H);
  ...
  SET_VECTOR_ELT(contents, 580, n_HD);
  ...
  SET_VECTOR_ELT(contents, 581, n_HR);
  ...
  SET_VECTOR_ELT(contents, 582, n_I);
  ...
  SET_VECTOR_ELT(contents, 583, n_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 584, n_ICU_HR);
  ...
  SET_VECTOR_ELT(contents, 585, n_ICU_P);
  ...
  SET_VECTOR_ELT(contents, 586, n_ICU_R);
  ...
  SET_VECTOR_ELT(contents, 587, n_ICU_RP);
  ...
  SET_VECTOR_ELT(contents, 588, n_ID);
  ...
  SET_VECTOR_ELT(contents, 589, n_IH);
  ...
  SET_VECTOR_ELT(contents, 590, n_IICU);
  ...
  SET_VECTOR_ELT(contents, 591, n_IR);
  ...
  SET_VECTOR_ELT(contents, 592, n_PI);
  ...
  SET_VECTOR_ELT(contents, 593, n_RS);
  ...
  SET_VECTOR_ELT(contents, 594, n_SE);
  ...
  SET_VECTOR_ELT(contents, 595, n_SE_tot);
  ...
  SET_VECTOR_ELT(contents, 596, n_SEa);
  ...
  SET_VECTOR_ELT(contents, 597, n_SEi);
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->n_strain));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->n_vac));
  ...
  SET_VECTOR_ELT(contents, 600, n_vac_help);
  ...
  SET_VECTOR_ELT(contents, 601, n_vac_now);
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->offset_output_N));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->offset_output_beta));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->offset_output_beta_spont_behaviour));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->offset_variable_B_D));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->offset_variable_B_D_H));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->offset_variable_B_D_ICU));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->offset_variable_Ea));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->offset_variable_Es));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->offset_variable_H));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->offset_variable_ICU_H));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->offset_variable_ICU_P));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->offset_variable_ICU_R));
  SET_VECTOR_ELT(contents, 617, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 618, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 619, ScalarInteger(internal->offset_variable_tot_hosp));
  SET_VECTOR_ELT(contents, 620, ScalarInteger(internal->offset_variable_tot_infected));
  SET_VECTOR_ELT(contents, 621, ScalarInteger(internal->offset_variable_tot_resp));
  SET_VECTOR_ELT(contents, 622, ScalarInteger(internal->offset_variable_tot_vac));
  SET_VECTOR_ELT(contents, 623, ScalarInteger(internal->offset_variable_tot_vac_adm));
  ...
  SET_VECTOR_ELT(contents, 624, p_SE);
  ...
  SET_VECTOR_ELT(contents, 625, pa);
  ...
  SET_VECTOR_ELT(contents, 626, post_icu);
  ...
  SET_VECTOR_ELT(contents, 627, pre_icu);
  SET_VECTOR_ELT(contents, 628, ScalarReal(internal->pre_sympt_infect));
  SET_VECTOR_ELT(contents, 629, ScalarReal(internal->pre_sympt_period));
  ...
  SET_VECTOR_ELT(contents, 630, prob_death_hosp);
  ...
  SET_VECTOR_ELT(contents, 631, prob_death_icu);
  ...
  SET_VECTOR_ELT(contents, 632, prob_death_non_hosp);
  SET_VECTOR_ELT(contents, 633, ScalarReal(internal->rand_beta_days));
  ...
  SET_VECTOR_ELT(contents, 634, spont_behav_change_params);
  SET_VECTOR_ELT(contents, 635, ScalarReal(internal->spont_behav_mode));
  ...
  SET_VECTOR_ELT(contents, 636, susceptibility_asymp);
  ...
  SET_VECTOR_ELT(contents, 637, susceptibility_symp);
  ...
  SET_VECTOR_ELT(contents, 638, symp_asymp_effect);
  ...
  SET_VECTOR_ELT(contents, 639, symp_trans);
  ...
  SET_VECTOR_ELT(contents, 640, sympt_frac);
  SET_VECTOR_ELT(contents, 641, ScalarReal(internal->threshold_ini));
  SET_VECTOR_ELT(contents, 642, ScalarReal(internal->threshold_max));
  SET_VECTOR_ELT(contents, 643, ScalarReal(internal->threshold_min));
  SET_VECTOR_ELT(contents, 644, ScalarReal(internal->time_before_death));
  SET_VECTOR_ELT(contents, 645, ScalarReal(internal->time_before_death_hosp));
  SET_VECTOR_ELT(contents, 646, ScalarReal(internal->time_before_death_icu));
  ...
  SET_VECTOR_ELT(contents, 647, tot_hosp_ini);
  ...
  SET_VECTOR_ELT(contents, 648, tot_infected_ini);
  ...
  SET_VECTOR_ELT(contents, 649, tot_resp_ini);
  ...
  SET_VECTOR_ELT(contents, 650, tot_vac_adm_ini);
  ...
  SET_VECTOR_ELT(contents, 651, tot_vac_ini);
  ...
  SET_VECTOR_ELT(contents, 652, transmisibility);
  SET_VECTOR_ELT(contents, 653, ScalarReal(internal->vac_struct_length));
  ...
  SET_VECTOR_ELT(contents, 654, vaccinations);
  ...
  SET_VECTOR_ELT(contents, 655, vax_time_step);
  SET_VECTOR_ELT(contents, 656, ScalarReal(internal->vax_type));
  SET_VECTOR_ELT(contents, 657, ScalarReal(internal->waning_immunity));
  ...
  SET_VECTOR_ELT(contents, 658, waning_immunity_vax);
  SET_VECTOR_ELT(contents, 659, ScalarReal(internal->waning_inf));
  ...
  SET_VECTOR_ELT(contents, 660, waning_tmp);
  SEXP nms = PROTECT(allocVector(STRSXP, 661));
  ...
  SET_STRING_ELT(nms, 408, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 409, mkChar("dim_p_SE_1"));
  SET_STRING_ELT(nms, 410, mkChar("dim_p_SE_12"));
  SET_STRING_ELT(nms, 411, mkChar("dim_p_SE_2"));
  SET_STRING_ELT(nms, 412, mkChar("dim_p_SE_3"));
  SET_STRING_ELT(nms, 413, mkChar("dim_pa"));
  SET_STRING_ELT(nms, 414, mkChar("dim_pa_1"));
  SET_STRING_ELT(nms, 415, mkChar("dim_pa_12"));
  SET_STRING_ELT(nms, 416, mkChar("dim_pa_2"));
  SET_STRING_ELT(nms, 417, mkChar("dim_pa_3"));
  SET_STRING_ELT(nms, 418, mkChar("dim_post_icu"));
  SET_STRING_ELT(nms, 419, mkChar("dim_post_icu_1"));
  SET_STRING_ELT(nms, 420, mkChar("dim_post_icu_12"));
  SET_STRING_ELT(nms, 421, mkChar("dim_post_icu_2"));
  SET_STRING_ELT(nms, 422, mkChar("dim_post_icu_3"));
  SET_STRING_ELT(nms, 423, mkChar("dim_pre_icu"));
  SET_STRING_ELT(nms, 424, mkChar("dim_pre_icu_1"));
  SET_STRING_ELT(nms, 425, mkChar("dim_pre_icu_12"));
  SET_STRING_ELT(nms, 426, mkChar("dim_pre_icu_2"));
  SET_STRING_ELT(nms, 427, mkChar("dim_pre_icu_3"));
  SET_STRING_ELT(nms, 428, mkChar("dim_prob_death_hosp"));
  SET_STRING_ELT(nms, 429, mkChar("dim_prob_death_hosp_1"));
  SET_STRING_ELT(nms, 430, mkChar("dim_prob_death_hosp_12"));
  SET_STRING_ELT(nms, 431, mkChar("dim_prob_death_hosp_2"));
  SET_STRING_ELT(nms, 432, mkChar("dim_prob_death_hosp_3"));
  SET_STRING_ELT(nms, 433, mkChar("dim_prob_death_icu"));
  SET_STRING_ELT(nms, 434, mkChar("dim_prob_death_icu_1"));
  SET_STRING_ELT(nms, 435, mkChar("dim_prob_death_icu_12"));
  SET_STRING_ELT(nms, 436, mkChar("dim_prob_death_icu_2"));
  SET_STRING_ELT(nms, 437, mkChar("dim_prob_death_icu_3"));
  SET_STRING_ELT(nms, 438, mkChar("dim_prob_death_non_hosp"));
  SET_STRING_ELT(nms, 439, mkChar("dim_prob_death_non_hosp_1"));
  SET_STRING_ELT(nms, 440, mkChar("dim_prob_death_non_hosp_12"));
  SET_STRING_ELT(nms, 441, mkChar("dim_prob_death_non_hosp_2"));
  SET_STRING_ELT(nms, 442, mkChar("dim_prob_death_non_hosp_3"));
  SET_STRING_ELT(nms, 443, mkChar("dim_spont_behav_change_params"));
  SET_STRING_ELT(nms, 444, mkChar("dim_susceptibility_asymp"));
  SET_STRING_ELT(nms, 445, mkChar("dim_susceptibility_asymp_1"));
  SET_STRING_ELT(nms, 446, mkChar("dim_susceptibility_asymp_12"));
  SET_STRING_ELT(nms, 447, mkChar("dim_susceptibility_asymp_2"));
  SET_STRING_ELT(nms, 448, mkChar("dim_susceptibility_asymp_3"));
  SET_STRING_ELT(nms, 449, mkChar("dim_susceptibility_symp"));
  SET_STRING_ELT(nms, 450, mkChar("dim_susceptibility_symp_1"));
  SET_STRING_ELT(nms, 451, mkChar("dim_susceptibility_symp_12"));
  SET_STRING_ELT(nms, 452, mkChar("dim_susceptibility_symp_2"));
  SET_STRING_ELT(nms, 453, mkChar("dim_susceptibility_symp_3"));
  SET_STRING_ELT(nms, 454, mkChar("dim_symp_asymp_effect"));
  SET_STRING_ELT(nms, 455, mkChar("dim_symp_asymp_effect_1"));
  SET_STRING_ELT(nms, 456, mkChar("dim_symp_asymp_effect_12"));
  SET_STRING_ELT(nms, 457, mkChar("dim_symp_asymp_effect_2"));
  SET_STRING_ELT(nms, 458, mkChar("dim_symp_asymp_effect_3"));
  SET_STRING_ELT(nms, 459, mkChar("dim_symp_trans"));
  SET_STRING_ELT(nms, 460, mkChar("dim_symp_trans_1"));
  SET_STRING_ELT(nms, 461, mkChar("dim_symp_trans_12"));
  SET_STRING_ELT(nms, 462, mkChar("dim_symp_trans_2"));
  SET_STRING_ELT(nms, 463, mkChar("dim_symp_trans_3"));
  SET_STRING_ELT(nms, 464, mkChar("dim_sympt_frac"));
  SET_STRING_ELT(nms, 465, mkChar("dim_sympt_frac_1"));
  SET_STRING_ELT(nms, 466, mkChar("dim_sympt_frac_12"));
  SET_STRING_ELT(nms, 467, mkChar("dim_sympt_frac_2"));
  SET_STRING_ELT(nms, 468, mkChar("dim_sympt_frac_3"));
  SET_STRING_ELT(nms, 469, mkChar("dim_tot_hosp"));
  SET_STRING_ELT(nms, 470, mkChar("dim_tot_hosp_1"));
  SET_STRING_ELT(nms, 471, mkChar("dim_tot_hosp_12"));
  SET_STRING_ELT(nms, 472, mkChar("dim_tot_hosp_2"));
  SET_STRING_ELT(nms, 473, mkChar("dim_tot_hosp_3"));
  SET_STRING_ELT(nms, 474, mkChar("dim_tot_hosp_ini"));
  SET_STRING_ELT(nms, 475, mkChar("dim_tot_hosp_ini_1"));
  SET_STRING_ELT(nms, 476, mkChar("dim_tot_hosp_ini_12"));
  SET_STRING_ELT(nms, 477, mkChar("dim_tot_hosp_ini_2"));
  SET_STRING_ELT(nms, 478, mkChar("dim_tot_hosp_ini_3"));
  SET_STRING_ELT(nms, 479, mkChar("dim_tot_infected"));
  SET_STRING_ELT(nms, 480, mkChar("dim_tot_infected_1"));
  SET_STRING_ELT(nms, 481, mkChar("dim_tot_infected_12"));
  SET_STRING_ELT(nms, 482, mkChar("dim_tot_infected_2"));
  SET_STRING_ELT(nms, 483, mkChar("dim_tot_infected_3"));
  SET_STRING_ELT(nms, 484, mkChar("dim_tot_infected_ini"));
  SET_STRING_ELT(nms, 485, mkChar("dim_tot_infected_ini_1"));
  SET_STRING_ELT(nms, 486, mkChar("dim_tot_infected_ini_12"));
  SET_STRING_ELT(nms, 487, mkChar("dim_tot_infected_ini_2"));
  SET_STRING_ELT(nms, 488, mkChar("dim_tot_infected_ini_3"));
  SET_STRING_ELT(nms, 489, mkChar("dim_tot_resp"));
  SET_STRING_ELT(nms, 490, mkChar("dim_tot_resp_1"));
  SET_STRING_ELT(nms, 491, mkChar("dim_tot_resp_12"));
  SET_STRING_ELT(nms, 492, mkChar("dim_tot_resp_2"));
  SET_STRING_ELT(nms, 493, mkChar("dim_tot_resp_3"));
  SET_STRING_ELT(nms, 494, mkChar("dim_tot_resp_ini"));
  SET_STRING_ELT(nms, 495, mkChar("dim_tot_resp_ini_1"));
  SET_STRING_ELT(nms, 496, mkChar("dim_tot_resp_ini_12"));
  SET_STRING_ELT(nms, 497, mkChar("dim_tot_resp_ini_2"));
  SET_STRING_ELT(nms, 498, mkChar("dim_tot_resp_ini_3"));
  SET_STRING_ELT(nms, 499, mkChar("dim_tot_vac"));
  SET_STRING_ELT(nms, 500, mkChar("dim_tot_vac_1"));
  SET_STRING_ELT(nms, 501, mkChar("dim_tot_vac_2"));
  SET_STRING_ELT(nms, 502, mkChar("dim_tot_vac_adm"));
  SET_STRING_ELT(nms, 503, mkChar("dim_tot_vac_adm_1"));
  SET_STRING_ELT(nms, 504, mkChar("dim_tot_vac_adm_2"));
  SET_STRING_ELT(nms, 505, mkChar("dim_tot_vac_adm_ini"));
  SET_STRING_ELT(nms, 506, mkChar("dim_tot_vac_adm_ini_1"));
  SET_STRING_ELT(nms, 507, mkChar("dim_tot_vac_adm_ini_2"));
  SET_STRING_ELT(nms, 508, mkChar("dim_tot_vac_ini"));
  SET_STRING_ELT(nms, 509, mkChar("dim_tot_vac_ini_1"));
  SET_STRING_ELT(nms, 510, mkChar("dim_tot_vac_ini_2"));
  SET_STRING_ELT(nms, 511, mkChar("dim_transmisibility"));
  SET_STRING_ELT(nms, 512, mkChar("dim_transmisibility_1"));
  SET_STRING_ELT(nms, 513, mkChar("dim_transmisibility_12"));
  SET_STRING_ELT(nms, 514, mkChar("dim_transmisibility_2"));
  SET_STRING_ELT(nms, 515, mkChar("dim_transmisibility_3"));
  SET_STRING_ELT(nms, 516, mkChar("dim_vaccinations"));
  SET_STRING_ELT(nms, 517, mkChar("dim_vaccinations_1"));
  SET_STRING_ELT(nms, 518, mkChar("dim_vaccinations_12"));
  SET_STRING_ELT(nms, 519, mkChar("dim_vaccinations_2"));
  SET_STRING_ELT(nms, 520, mkChar("dim_vaccinations_3"));
  SET_STRING_ELT(nms, 521, mkChar("dim_vax_time_step"));
  SET_STRING_ELT(nms, 522, mkChar("dim_vax_time_step_1"));
  SET_STRING_ELT(nms, 523, mkChar("dim_vax_time_step_2"));
  SET_STRING_ELT(nms, 524, mkChar("dim_waning_immunity_vax"));
  SET_STRING_ELT(nms, 525, mkChar("dim_waning_immunity_vax_1"));
  SET_STRING_ELT(nms, 526, mkChar("dim_waning_immunity_vax_12"));
  SET_STRING_ELT(nms, 527, mkChar("dim_waning_immunity_vax_2"));
  SET_STRING_ELT(nms, 528, mkChar("dim_waning_immunity_vax_3"));
  SET_STRING_ELT(nms, 529, mkChar("dim_waning_tmp"));
  SET_STRING_ELT(nms, 530, mkChar("dim_waning_tmp_1"));
  SET_STRING_ELT(nms, 531, mkChar("dim_waning_tmp_2"));
  SET_STRING_ELT(nms, 532, mkChar("expected_health_loss"));
  SET_STRING_ELT(nms, 533, mkChar("hosp_prob"));
  SET_STRING_ELT(nms, 534, mkChar("icu_prob"));
  SET_STRING_ELT(nms, 535, mkChar("import_vec"));
  SET_STRING_ELT(nms, 536, mkChar("incidence_steps_measurement"));
  SET_STRING_ELT(nms, 537, mkChar("include_waning"));
  SET_STRING_ELT(nms, 538, mkChar("index"));
  SET_STRING_ELT(nms, 539, mkChar("infectious_period"));
  SET_STRING_ELT(nms, 540, mkChar("initial_A"));
  SET_STRING_ELT(nms, 541, mkChar("initial_B_D"));
  SET_STRING_ELT(nms, 542, mkChar("initial_B_D_H"));
  SET_STRING_ELT(nms, 543, mkChar("initial_B_D_ICU"));
  SET_STRING_ELT(nms, 544, mkChar("initial_D"));
  SET_STRING_ELT(nms, 545, mkChar("initial_Ea"));
  SET_STRING_ELT(nms, 546, mkChar("initial_Es"));
  SET_STRING_ELT(nms, 547, mkChar("initial_H"));
  SET_STRING_ELT(nms, 548, mkChar("initial_I"));
  SET_STRING_ELT(nms, 549, mkChar("initial_ICU_H"));
  SET_STRING_ELT(nms, 550, mkChar("initial_ICU_P"));
  SET_STRING_ELT(nms, 551, mkChar("initial_ICU_R"));
  SET_STRING_ELT(nms, 552, mkChar("initial_P"));
  SET_STRING_ELT(nms, 553, mkChar("initial_R"));
  SET_STRING_ELT(nms, 554, mkChar("initial_S"));
  SET_STRING_ELT(nms, 555, mkChar("initial_tot_hosp"));
  SET_STRING_ELT(nms, 556, mkChar("initial_tot_hosp_inc"));
  SET_STRING_ELT(nms, 557, mkChar("initial_tot_infected"));
  SET_STRING_ELT(nms, 558, mkChar("initial_tot_resp"));
  SET_STRING_ELT(nms, 559, mkChar("initial_tot_vac"));
  SET_STRING_ELT(nms, 560, mkChar("initial_tot_vac_adm"));
  SET_STRING_ELT(nms, 561, mkChar("interpolate_N_imp"));
  SET_STRING_ELT(nms, 562, mkChar("interpolate_beta_int"));
  SET_STRING_ELT(nms, 563, mkChar("interpolate_vax_time_step"));
  SET_STRING_ELT(nms, 564, mkChar("interpolation_time"));
  SET_STRING_ELT(nms, 565, mkChar("kernel"));
  SET_STRING_ELT(nms, 566, mkChar("lambda_ij"));
  SET_STRING_ELT(nms, 567, mkChar("latent_period"));
  SET_STRING_ELT(nms, 568, mkChar("length_hosp"));
  SET_STRING_ELT(nms, 569, mkChar("length_icu"));
  SET_STRING_ELT(nms, 570, mkChar("log_beta_ini"));
  SET_STRING_ELT(nms, 571, mkChar("mixing_matrix"));
  SET_STRING_ELT(nms, 572, mkChar("n"));
  SET_STRING_ELT(nms, 573, mkChar("n_AR"));
  SET_STRING_ELT(nms, 574, mkChar("n_B_D_D"));
  SET_STRING_ELT(nms, 575, mkChar("n_B_H_D"));
  SET_STRING_ELT(nms, 576, mkChar("n_B_ICU_D"));
  SET_STRING_ELT(nms, 577, mkChar("n_EaA"));
  SET_STRING_ELT(nms, 578, mkChar("n_EsI"));
  SET_STRING_ELT(nms, 579, mkChar("n_H"));
  SET_STRING_ELT(nms, 580, mkChar("n_HD"));
  SET_STRING_ELT(nms, 581, mkChar("n_HR"));
  SET_STRING_ELT(nms, 582, mkChar("n_I"));
  SET_STRING_ELT(nms, 583, mkChar("n_ICU_D"));
  SET_STRING_ELT(nms, 584, mkChar("n_ICU_HR"));
  SET_STRING_ELT(nms, 585, mkChar("n_ICU_P"));
  SET_STRING_ELT(nms, 586, mkChar("n_ICU_R"));
  SET_STRING_ELT(nms, 587, mkChar("n_ICU_RP"));
  SET_STRING_ELT(nms, 588, mkChar("n_ID"));
  SET_STRING_ELT(nms, 589, mkChar("n_IH"));
  SET_STRING_ELT(nms, 590, mkChar("n_IICU"));
  SET_STRING_ELT(nms, 591, mkChar("n_IR"));
  SET_STRING_ELT(nms, 592, mkChar("n_PI"));
  SET_STRING_ELT(nms, 593, mkChar("n_RS"));
  SET_STRING_ELT(nms, 594, mkChar("n_SE"));
  SET_STRING_ELT(nms, 595, mkChar("n_SE_tot"));
  SET_STRING_ELT(nms, 596, mkChar("n_SEa"));
  SET_STRING_ELT(nms, 597, mkChar("n_SEi"));
  SET_STRING_ELT(nms, 598, mkChar("n_strain"));
  SET_STRING_ELT(nms, 599, mkChar("n_vac"));
  SET_STRING_ELT(nms, 600, mkChar("n_vac_help"));
  SET_STRING_ELT(nms, 601, mkChar("n_vac_now"));
  SET_STRING_ELT(nms, 602, mkChar("offset_output_N"));
  SET_STRING_ELT(nms, 603, mkChar("offset_output_beta"));
  SET_STRING_ELT(nms, 604, mkChar("offset_output_beta_spont_behaviour"));
  SET_STRING_ELT(nms, 605, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 606, mkChar("offset_variable_B_D"));
  SET_STRING_ELT(nms, 607, mkChar("offset_variable_B_D_H"));
  SET_STRING_ELT(nms, 608, mkChar("offset_variable_B_D_ICU"));
  SET_STRING_ELT(nms, 609, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 610, mkChar("offset_variable_Ea"));
  SET_STRING_ELT(nms, 611, mkChar("offset_variable_Es"));
  SET_STRING_ELT(nms, 612, mkChar("offset_variable_H"));
  SET_STRING_ELT(nms, 613, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 614, mkChar("offset_variable_ICU_H"));
  SET_STRING_ELT(nms, 615, mkChar("offset_variable_ICU_P"));
  SET_STRING_ELT(nms, 616, mkChar("offset_variable_ICU_R"));
  SET_STRING_ELT(nms, 617, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 618, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 619, mkChar("offset_variable_tot_hosp"));
  SET_STRING_ELT(nms, 620, mkChar("offset_variable_tot_infected"));
  SET_STRING_ELT(nms, 621, mkChar("offset_variable_tot_resp"));
  SET_STRING_ELT(nms, 622, mkChar("offset_variable_tot_vac"));
  SET_STRING_ELT(nms, 623, mkChar("offset_variable_tot_vac_adm"));
  SET_STRING_ELT(nms, 624, mkChar("p_SE"));
  SET_STRING_ELT(nms, 625, mkChar("pa"));
  SET_STRING_ELT(nms, 626, mkChar("post_icu"));
  SET_STRING_ELT(nms, 627, mkChar("pre_icu"));
  SET_STRING_ELT(nms, 628, mkChar("pre_sympt_infect"));
  SET_STRING_ELT(nms, 629, mkChar("pre_sympt_period"));
  SET_STRING_ELT(nms, 630, mkChar("prob_death_hosp"));
  SET_STRING_ELT(nms, 631, mkChar("prob_death_icu"));
  SET_STRING_ELT(nms, 632, mkChar("prob_death_non_hosp"));
  SET_STRING_ELT(nms, 633, mkChar("rand_beta_days"));
  SET_STRING_ELT(nms, 634, mkChar("spont_behav_change_params"));
  SET_STRING_ELT(nms, 635, mkChar("spont_behav_mode"));
  SET_STRING_ELT(nms, 636, mkChar("susceptibility_asymp"));
  SET_STRING_ELT(nms, 637, mkChar("susceptibility_symp"));
  SET_STRING_ELT(nms, 638, mkChar("symp_asymp_effect"));
  SET_STRING_ELT(nms, 639, mkChar("symp_trans"));
  SET_STRING_ELT(nms, 640, mkChar("sympt_frac"));
  SET_STRING_ELT(nms, 641, mkChar("threshold_ini"));
  SET_STRING_ELT(nms, 642, mkChar("threshold_max"));
  SET_STRING_ELT(nms, 643, mkChar("threshold_min"));
  SET_STRING_ELT(nms, 644, mkChar("time_before_death"));
  SET_STRING_ELT(nms, 645, mkChar("time_before_death_hosp"));
  SET_STRING_ELT(nms, 646, mkChar("time_before_death_icu"));
  SET_STRING_ELT(nms, 647, mkChar("tot_hosp_ini"));
  SET_STRING_ELT(nms, 648, mkChar("tot_infected_ini"));
  SET_STRING_ELT(nms, 649, mkChar("tot_resp_ini"));
  SET_STRING_ELT(nms, 650, mkChar("tot_vac_adm_ini"));
  SET_STRING_ELT(nms, 651, mkChar("tot_vac_ini"));
  SET_STRING_ELT(nms, 652, mkChar("transmisibility"));
  SET_STRING_ELT(nms, 653, mkChar("vac_struct_length"));
  SET_STRING_ELT(nms, 654, mkChar("vaccinations"));
  SET_STRING_ELT(nms, 655, mkChar("vax_time_step"));
  SET_STRING_ELT(nms, 656, mkChar("vax_type"));
  SET_STRING_ELT(nms, 657, mkChar("waning_immunity"));
  SET_STRING_ELT(nms, 658, mkChar("waning_immunity_vax"));
  SET_STRING_ELT(nms, 659, mkChar("waning_inf"));
  SET_STRING_ELT(nms, 660, mkChar("waning_tmp"));
...
void model_deterministic_rhs(model_deterministic_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_contact_change_1; ++i) {
    for (int j = 1; j <= internal->dim_contact_change_2; ++j) {
      internal->contact_change[i - 1 + internal->dim_contact_change_1 * (j - 1)] = (internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1] > 15 ? 1 : ((internal->spont_behav_mode == 1 ? exp(internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1]) / (double) (1 + exp(internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1])) : (internal->spont_behav_change_params[6] - log(exp(internal->a * internal->C[internal->dim_C_1 * (j - 1) + i - 1]) + exp(internal->a * internal->W)) / (double) internal->a + log(exp(internal->a * internal->C[internal->dim_C_1 * (j - 1) + i - 1]) + 1)) / (double) internal->spont_behav_change_params[6])));
    }
  }

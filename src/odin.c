...
SEXP model_deterministic_create(SEXP user) {
  ...
  internal->dim_spont_behav_change_params = 6;
...
SEXP model_deterministic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 653));
  ...
  SET_VECTOR_ELT(contents, 4, D_ini);
  ...
  SET_VECTOR_ELT(contents, 5, Ea_ini);
  ...
  SET_VECTOR_ELT(contents, 6, Es_ini);
  ...
  SET_VECTOR_ELT(contents, 7, H_ini);
  ...
  SET_VECTOR_ELT(contents, 8, ICU_H_ini);
  ...
  SET_VECTOR_ELT(contents, 9, ICU_P_ini);
  ...
  SET_VECTOR_ELT(contents, 10, ICU_R_ini);
  ...
  SET_VECTOR_ELT(contents, 11, I_imp_ini);
  ...
  SET_VECTOR_ELT(contents, 12, I_ini);
  ...
  SET_VECTOR_ELT(contents, 14, N_imp);
  ...
  SET_VECTOR_ELT(contents, 15, N_imp_non_zero);
  SET_VECTOR_ELT(contents, 16, ScalarInteger(internal->N_steps));
  ...
  SET_VECTOR_ELT(contents, 17, P_ini);
  ...
  SET_VECTOR_ELT(contents, 18, R_ini);
  ...
  SET_VECTOR_ELT(contents, 19, S_ini);
  ...
  SET_VECTOR_ELT(contents, 20, T_waning);
  ...
  SET_VECTOR_ELT(contents, 21, asympt_frac);
  SET_VECTOR_ELT(contents, 22, ScalarReal(internal->asympt_infect));
  ...
  SET_VECTOR_ELT(contents, 23, beta);
  ...
  SET_VECTOR_ELT(contents, 24, beta_day);
  ...
  SET_VECTOR_ELT(contents, 25, beta_int);
  SET_VECTOR_ELT(contents, 26, ScalarReal(internal->beta_mode));
  ...
  SET_VECTOR_ELT(contents, 27, beta_norm);
  ...
  SET_VECTOR_ELT(contents, 28, beta_reduction);
  ...
  SET_VECTOR_ELT(contents, 29, beta_spont_behaviour);
  ...
  SET_VECTOR_ELT(contents, 30, beta_strain);
  ...
  SET_VECTOR_ELT(contents, 31, contact_change);
  ...
  SET_VECTOR_ELT(contents, 32, cross_protection);
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_A));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_A_1));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_A_12));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_A_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_A_3));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_A_ini));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_A_ini_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_A_ini_12));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_A_ini_2));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_A_ini_3));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_B_D));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_B_D_1));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_B_D_12));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_B_D_2));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_B_D_3));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_B_D_H));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_B_D_H_1));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_B_D_H_12));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_B_D_H_2));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_B_D_H_3));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_B_D_H_ini));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_B_D_H_ini_1));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_B_D_H_ini_12));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_B_D_H_ini_2));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_B_D_H_ini_3));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_B_D_ICU));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_B_D_ICU_1));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_B_D_ICU_12));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_B_D_ICU_2));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_B_D_ICU_3));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_B_D_ICU_ini));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_B_D_ICU_ini_1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_B_D_ICU_ini_12));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_B_D_ICU_ini_2));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_B_D_ICU_ini_3));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_B_D_ini));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_B_D_ini_1));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_B_D_ini_12));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_B_D_ini_2));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_B_D_ini_3));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_D_1));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_D_12));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_D_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_D_3));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_D_ini));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_D_ini_1));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_D_ini_12));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_D_ini_2));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_D_ini_3));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_Ea));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_Ea_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_Ea_12));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_Ea_2));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_Ea_3));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_Ea_ini));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_Ea_ini_1));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_Ea_ini_12));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_Ea_ini_2));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_Ea_ini_3));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_Es));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_Es_1));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_Es_12));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_Es_2));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_Es_3));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_Es_ini));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_Es_ini_1));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_Es_ini_12));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_Es_ini_2));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_Es_ini_3));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_H));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_H_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_H_12));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_H_2));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_H_3));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_H_ini));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_H_ini_1));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_H_ini_12));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_H_ini_2));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_H_ini_3));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_ICU_H));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_ICU_H_1));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_ICU_H_12));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_ICU_H_2));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_ICU_H_3));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_ICU_H_ini));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_ICU_H_ini_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_ICU_H_ini_12));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_ICU_H_ini_2));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_ICU_H_ini_3));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_ICU_P));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_ICU_P_1));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_ICU_P_12));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_ICU_P_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_ICU_P_3));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_ICU_P_ini));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_ICU_P_ini_1));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_ICU_P_ini_12));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_ICU_P_ini_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_ICU_P_ini_3));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_ICU_R));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_ICU_R_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_ICU_R_12));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_ICU_R_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_ICU_R_3));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_ICU_R_ini));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_ICU_R_ini_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_ICU_R_ini_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_ICU_R_ini_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_ICU_R_ini_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_I_12));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_I_3));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_I_imp_ini));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_I_imp_ini_1));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_I_imp_ini_12));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_I_imp_ini_2));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_I_imp_ini_3));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_I_ini));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_I_ini_1));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_I_ini_12));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_I_ini_2));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_I_ini_3));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_N_imp));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_N_imp_1));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_N_imp_12));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_N_imp_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_N_imp_3));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_N_imp_non_zero));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_N_imp_non_zero_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_N_imp_non_zero_12));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_N_imp_non_zero_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_N_imp_non_zero_3));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_P));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_P_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_P_12));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_P_2));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_P_3));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_P_ini));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_P_ini_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_P_ini_12));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_P_ini_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_P_ini_3));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_R_1));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_R_12));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_R_2));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_R_3));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_R_ini));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_R_ini_1));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_R_ini_12));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_R_ini_2));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_R_ini_3));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_S_ini));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_S_ini_1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_S_ini_2));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_T_waning));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_T_waning_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_T_waning_2));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_asympt_frac));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_asympt_frac_1));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_asympt_frac_12));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_asympt_frac_2));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_asympt_frac_3));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_beta));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_beta_1));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_beta_2));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_beta_day));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_beta_day_1));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_beta_day_2));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_beta_int));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_beta_norm));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_beta_reduction));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_beta_reduction_1));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_beta_reduction_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_beta_spont_behaviour));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_beta_spont_behaviour_1));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_beta_spont_behaviour_2));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_beta_strain));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_contact_change));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_contact_change_1));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_contact_change_2));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_cross_protection));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_cross_protection_1));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_cross_protection_2));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_expected_health_loss));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_expected_health_loss_1));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_expected_health_loss_2));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_hosp_prob));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_hosp_prob_1));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_hosp_prob_12));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_hosp_prob_2));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_hosp_prob_3));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_icu_prob));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_icu_prob_1));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_icu_prob_12));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_icu_prob_2));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_icu_prob_3));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_import_vec));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_import_vec_1));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_import_vec_12));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_import_vec_123));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_import_vec_2));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_import_vec_3));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_import_vec_4));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_index));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_interpolation_time));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_kernel));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_kernel_1));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_kernel_2));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_lambda_ij));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_lambda_ij_1));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_lambda_ij_12));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_lambda_ij_123));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_lambda_ij_1234));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_lambda_ij_2));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_lambda_ij_3));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_lambda_ij_4));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_lambda_ij_5));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_length_hosp));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_length_hosp_1));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_length_hosp_12));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_length_hosp_2));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_length_hosp_3));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_length_icu));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_length_icu_1));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_length_icu_12));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_length_icu_2));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_length_icu_3));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_mixing_matrix));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_mixing_matrix_1));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_mixing_matrix_2));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_n_AR));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_n_AR_1));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_n_AR_12));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_n_AR_2));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_n_AR_3));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_n_B_D_D));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_n_B_D_D_1));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_n_B_D_D_12));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_n_B_D_D_2));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_n_B_D_D_3));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_n_B_H_D));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_n_B_H_D_1));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_n_B_H_D_12));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_n_B_H_D_2));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_n_B_H_D_3));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_n_B_ICU_D));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_n_B_ICU_D_1));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_n_B_ICU_D_12));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_n_B_ICU_D_2));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_n_B_ICU_D_3));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_n_EaA));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_n_EaA_1));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_n_EaA_12));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_n_EaA_2));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_n_EaA_3));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_n_EsI));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_n_EsI_1));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_n_EsI_12));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_n_EsI_2));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_n_EsI_3));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_n_H));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_n_HD));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_n_HD_1));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_n_HD_12));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_n_HD_2));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_n_HD_3));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_n_HR));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_n_HR_1));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_n_HR_12));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_n_HR_2));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_n_HR_3));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_n_H_1));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_n_H_12));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_n_H_2));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_n_H_3));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_n_I));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_n_ICU_D));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_n_ICU_D_1));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_n_ICU_D_12));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_n_ICU_D_2));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_n_ICU_D_3));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_n_ICU_HR));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_n_ICU_HR_1));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_n_ICU_HR_12));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_n_ICU_HR_2));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_n_ICU_HR_3));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_n_ICU_P));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_n_ICU_P_1));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_n_ICU_P_12));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_n_ICU_P_2));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_n_ICU_P_3));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_n_ICU_R));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_n_ICU_RP));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_n_ICU_RP_1));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_n_ICU_RP_12));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_n_ICU_RP_2));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_n_ICU_RP_3));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_n_ICU_R_1));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_n_ICU_R_12));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_n_ICU_R_2));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_n_ICU_R_3));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_n_ID));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_n_ID_1));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_n_ID_12));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_n_ID_2));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_n_ID_3));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_n_IH));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_n_IH_1));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_n_IH_12));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_n_IH_2));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_n_IH_3));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_n_IICU));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_n_IICU_1));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_n_IICU_12));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_n_IICU_2));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_n_IICU_3));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_n_IR));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_n_IR_1));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_n_IR_12));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_n_IR_2));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_n_IR_3));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_n_I_1));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_n_I_12));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_n_I_2));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_n_I_3));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_n_PI));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_n_PI_1));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_n_PI_12));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_n_PI_2));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_n_PI_3));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_n_RS));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_n_RS_1));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_n_RS_12));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_n_RS_2));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_n_RS_3));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_n_SE));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_n_SE_1));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_n_SE_12));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_n_SE_2));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_n_SE_3));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_n_SE_tot));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_n_SE_tot_1));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_n_SE_tot_2));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_n_SEa));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_n_SEa_1));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_n_SEa_12));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_n_SEa_2));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_n_SEa_3));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_n_SEi));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_n_SEi_1));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->dim_n_SEi_12));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->dim_n_SEi_2));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_n_SEi_3));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_n_vac_help));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_n_vac_help_1));
  SET_VECTOR_ELT(contents, 398, ScalarInteger(internal->dim_n_vac_help_2));
  SET_VECTOR_ELT(contents, 399, ScalarInteger(internal->dim_n_vac_now));
  SET_VECTOR_ELT(contents, 400, ScalarInteger(internal->dim_n_vac_now_1));
  SET_VECTOR_ELT(contents, 401, ScalarInteger(internal->dim_n_vac_now_2));
  SET_VECTOR_ELT(contents, 402, ScalarInteger(internal->dim_p_SE));
  SET_VECTOR_ELT(contents, 403, ScalarInteger(internal->dim_p_SE_1));
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->dim_p_SE_12));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->dim_p_SE_2));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->dim_p_SE_3));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->dim_pa));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_pa_1));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_pa_12));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_pa_2));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_pa_3));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_post_icu));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_post_icu_1));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_post_icu_12));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_post_icu_2));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_post_icu_3));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_pre_icu));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_pre_icu_1));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_pre_icu_12));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_pre_icu_2));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_pre_icu_3));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_prob_death_hosp));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_prob_death_hosp_1));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_prob_death_hosp_12));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_prob_death_hosp_2));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_prob_death_hosp_3));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_prob_death_icu));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_prob_death_icu_1));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_prob_death_icu_12));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_prob_death_icu_2));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_prob_death_icu_3));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_prob_death_non_hosp));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_prob_death_non_hosp_1));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_prob_death_non_hosp_12));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_prob_death_non_hosp_2));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_prob_death_non_hosp_3));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_spont_behav_change_params));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_susceptibility_asymp));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_susceptibility_asymp_1));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_susceptibility_asymp_12));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_susceptibility_asymp_2));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_susceptibility_asymp_3));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_susceptibility_symp));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_susceptibility_symp_1));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_susceptibility_symp_12));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_susceptibility_symp_2));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_susceptibility_symp_3));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_symp_asymp_effect));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_symp_asymp_effect_1));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_symp_asymp_effect_12));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_symp_asymp_effect_2));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_symp_asymp_effect_3));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_symp_trans));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_symp_trans_1));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_symp_trans_12));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_symp_trans_2));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_symp_trans_3));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_sympt_frac));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_sympt_frac_1));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_sympt_frac_12));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_sympt_frac_2));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_sympt_frac_3));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_tot_hosp));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_tot_hosp_1));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_tot_hosp_12));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_tot_hosp_2));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_tot_hosp_3));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_tot_hosp_ini));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_tot_hosp_ini_1));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_tot_hosp_ini_12));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_tot_hosp_ini_2));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_tot_hosp_ini_3));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_tot_infected));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_tot_infected_1));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_tot_infected_12));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_tot_infected_2));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_tot_infected_3));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_tot_infected_ini));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_tot_infected_ini_1));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_tot_infected_ini_12));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_tot_infected_ini_2));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_tot_infected_ini_3));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_tot_resp));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_tot_resp_1));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_tot_resp_12));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_tot_resp_2));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_tot_resp_3));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_tot_resp_ini));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_tot_resp_ini_1));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_tot_resp_ini_12));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_tot_resp_ini_2));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_tot_resp_ini_3));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_tot_vac));
  SET_VECTOR_ELT(contents, 494, ScalarInteger(internal->dim_tot_vac_1));
  SET_VECTOR_ELT(contents, 495, ScalarInteger(internal->dim_tot_vac_2));
  SET_VECTOR_ELT(contents, 496, ScalarInteger(internal->dim_tot_vac_adm));
  SET_VECTOR_ELT(contents, 497, ScalarInteger(internal->dim_tot_vac_adm_1));
  SET_VECTOR_ELT(contents, 498, ScalarInteger(internal->dim_tot_vac_adm_2));
  SET_VECTOR_ELT(contents, 499, ScalarInteger(internal->dim_tot_vac_adm_ini));
  SET_VECTOR_ELT(contents, 500, ScalarInteger(internal->dim_tot_vac_adm_ini_1));
  SET_VECTOR_ELT(contents, 501, ScalarInteger(internal->dim_tot_vac_adm_ini_2));
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->dim_tot_vac_ini));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->dim_tot_vac_ini_1));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->dim_tot_vac_ini_2));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->dim_transmisibility));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->dim_transmisibility_1));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->dim_transmisibility_12));
  SET_VECTOR_ELT(contents, 508, ScalarInteger(internal->dim_transmisibility_2));
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->dim_transmisibility_3));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->dim_vaccinations));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->dim_vaccinations_1));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->dim_vaccinations_12));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->dim_vaccinations_2));
  SET_VECTOR_ELT(contents, 514, ScalarInteger(internal->dim_vaccinations_3));
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->dim_vax_time_step));
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_vax_time_step_1));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_vax_time_step_2));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_waning_immunity_vax));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_waning_immunity_vax_1));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_waning_immunity_vax_12));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_waning_immunity_vax_2));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_waning_immunity_vax_3));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_waning_tmp));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_waning_tmp_1));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_waning_tmp_2));
  ...
  SET_VECTOR_ELT(contents, 526, expected_health_loss);
  ...
  SET_VECTOR_ELT(contents, 527, hosp_prob);
  ...
  SET_VECTOR_ELT(contents, 528, icu_prob);
  ...
  SET_VECTOR_ELT(contents, 529, import_vec);
  SET_VECTOR_ELT(contents, 530, ScalarReal(internal->incidence_steps_measurement));
  SET_VECTOR_ELT(contents, 531, ScalarReal(internal->include_waning));
  ...
  SET_VECTOR_ELT(contents, 532, index);
  SET_VECTOR_ELT(contents, 533, ScalarReal(internal->infectious_period));
  ...
  SET_VECTOR_ELT(contents, 534, initial_A);
  ...
  SET_VECTOR_ELT(contents, 535, initial_B_D);
  ...
  SET_VECTOR_ELT(contents, 536, initial_B_D_H);
  ...
  SET_VECTOR_ELT(contents, 537, initial_B_D_ICU);
  ...
  SET_VECTOR_ELT(contents, 538, initial_D);
  ...
  SET_VECTOR_ELT(contents, 539, initial_Ea);
  ...
  SET_VECTOR_ELT(contents, 540, initial_Es);
  ...
  SET_VECTOR_ELT(contents, 541, initial_H);
  ...
  SET_VECTOR_ELT(contents, 542, initial_I);
  ...
  SET_VECTOR_ELT(contents, 543, initial_ICU_H);
  ...
  SET_VECTOR_ELT(contents, 544, initial_ICU_P);
  ...
  SET_VECTOR_ELT(contents, 545, initial_ICU_R);
  ...
  SET_VECTOR_ELT(contents, 546, initial_P);
  ...
  SET_VECTOR_ELT(contents, 547, initial_R);
  ...
  SET_VECTOR_ELT(contents, 548, initial_S);
  ...
  SET_VECTOR_ELT(contents, 549, initial_tot_hosp);
  SET_VECTOR_ELT(contents, 550, ScalarReal(internal->initial_tot_hosp_inc));
  ...
  SET_VECTOR_ELT(contents, 551, initial_tot_infected);
  ...
  SET_VECTOR_ELT(contents, 552, initial_tot_resp);
  ...
  SET_VECTOR_ELT(contents, 553, initial_tot_vac);
  ...
  SET_VECTOR_ELT(contents, 554, initial_tot_vac_adm);
  ...
  SET_VECTOR_ELT(contents, 558, interpolation_time);
  ...
  SET_VECTOR_ELT(contents, 559, kernel);
  ...
  SET_VECTOR_ELT(contents, 560, lambda_ij);
  SET_VECTOR_ELT(contents, 561, ScalarReal(internal->latent_period));
  ...
  SET_VECTOR_ELT(contents, 562, length_hosp);
  ...
  SET_VECTOR_ELT(contents, 563, length_icu);
  SET_VECTOR_ELT(contents, 564, ScalarReal(internal->log_beta_ini));
  ...
  SET_VECTOR_ELT(contents, 565, mixing_matrix);
  SET_VECTOR_ELT(contents, 566, ScalarInteger(internal->n));
  ...
  SET_VECTOR_ELT(contents, 567, n_AR);
  ...
  SET_VECTOR_ELT(contents, 568, n_B_D_D);
  ...
  SET_VECTOR_ELT(contents, 569, n_B_H_D);
  ...
  SET_VECTOR_ELT(contents, 570, n_B_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 571, n_EaA);
  ...
  SET_VECTOR_ELT(contents, 572, n_EsI);
  ...
  SET_VECTOR_ELT(contents, 573, n_H);
  ...
  SET_VECTOR_ELT(contents, 574, n_HD);
  ...
  SET_VECTOR_ELT(contents, 575, n_HR);
  ...
  SET_VECTOR_ELT(contents, 576, n_I);
  ...
  SET_VECTOR_ELT(contents, 577, n_ICU_D);
  ...
  SET_VECTOR_ELT(contents, 578, n_ICU_HR);
  ...
  SET_VECTOR_ELT(contents, 579, n_ICU_P);
  ...
  SET_VECTOR_ELT(contents, 580, n_ICU_R);
  ...
  SET_VECTOR_ELT(contents, 581, n_ICU_RP);
  ...
  SET_VECTOR_ELT(contents, 582, n_ID);
  ...
  SET_VECTOR_ELT(contents, 583, n_IH);
  ...
  SET_VECTOR_ELT(contents, 584, n_IICU);
  ...
  SET_VECTOR_ELT(contents, 585, n_IR);
  ...
  SET_VECTOR_ELT(contents, 586, n_PI);
  ...
  SET_VECTOR_ELT(contents, 587, n_RS);
  ...
  SET_VECTOR_ELT(contents, 588, n_SE);
  ...
  SET_VECTOR_ELT(contents, 589, n_SE_tot);
  ...
  SET_VECTOR_ELT(contents, 590, n_SEa);
  ...
  SET_VECTOR_ELT(contents, 591, n_SEi);
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->n_strain));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->n_vac));
  ...
  SET_VECTOR_ELT(contents, 594, n_vac_help);
  ...
  SET_VECTOR_ELT(contents, 595, n_vac_now);
  SET_VECTOR_ELT(contents, 596, ScalarInteger(internal->offset_output_N));
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->offset_output_beta_spont_behaviour));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->offset_variable_B_D));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->offset_variable_B_D_H));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->offset_variable_B_D_ICU));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->offset_variable_Ea));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->offset_variable_Es));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->offset_variable_H));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->offset_variable_ICU_H));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->offset_variable_ICU_P));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->offset_variable_ICU_R));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->offset_variable_R));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->offset_variable_tot_hosp));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->offset_variable_tot_infected));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->offset_variable_tot_resp));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->offset_variable_tot_vac));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->offset_variable_tot_vac_adm));
  ...
  SET_VECTOR_ELT(contents, 617, p_SE);
  ...
  SET_VECTOR_ELT(contents, 618, pa);
  ...
  SET_VECTOR_ELT(contents, 619, post_icu);
  ...
  SET_VECTOR_ELT(contents, 620, pre_icu);
  SET_VECTOR_ELT(contents, 621, ScalarReal(internal->pre_sympt_infect));
  SET_VECTOR_ELT(contents, 622, ScalarReal(internal->pre_sympt_period));
  ...
  SET_VECTOR_ELT(contents, 623, prob_death_hosp);
  ...
  SET_VECTOR_ELT(contents, 624, prob_death_icu);
  ...
  SET_VECTOR_ELT(contents, 625, prob_death_non_hosp);
  SET_VECTOR_ELT(contents, 626, ScalarReal(internal->rand_beta_days));
  ...
  SET_VECTOR_ELT(contents, 627, spont_behav_change_params);
  ...
  SET_VECTOR_ELT(contents, 628, susceptibility_asymp);
  ...
  SET_VECTOR_ELT(contents, 629, susceptibility_symp);
  ...
  SET_VECTOR_ELT(contents, 630, symp_asymp_effect);
  ...
  SET_VECTOR_ELT(contents, 631, symp_trans);
  ...
  SET_VECTOR_ELT(contents, 632, sympt_frac);
  SET_VECTOR_ELT(contents, 633, ScalarReal(internal->threshold_ini));
  SET_VECTOR_ELT(contents, 634, ScalarReal(internal->threshold_max));
  SET_VECTOR_ELT(contents, 635, ScalarReal(internal->threshold_min));
  SET_VECTOR_ELT(contents, 636, ScalarReal(internal->time_before_death));
  SET_VECTOR_ELT(contents, 637, ScalarReal(internal->time_before_death_hosp));
  SET_VECTOR_ELT(contents, 638, ScalarReal(internal->time_before_death_icu));
  ...
  SET_VECTOR_ELT(contents, 639, tot_hosp_ini);
  ...
  SET_VECTOR_ELT(contents, 640, tot_infected_ini);
  ...
  SET_VECTOR_ELT(contents, 641, tot_resp_ini);
  ...
  SET_VECTOR_ELT(contents, 642, tot_vac_adm_ini);
  ...
  SET_VECTOR_ELT(contents, 643, tot_vac_ini);
  ...
  SET_VECTOR_ELT(contents, 644, transmisibility);
  SET_VECTOR_ELT(contents, 645, ScalarReal(internal->vac_struct_length));
  ...
  SET_VECTOR_ELT(contents, 646, vaccinations);
  ...
  SET_VECTOR_ELT(contents, 647, vax_time_step);
  SET_VECTOR_ELT(contents, 648, ScalarReal(internal->vax_type));
  SET_VECTOR_ELT(contents, 649, ScalarReal(internal->waning_immunity));
  ...
  SET_VECTOR_ELT(contents, 650, waning_immunity_vax);
  SET_VECTOR_ELT(contents, 651, ScalarReal(internal->waning_inf));
  ...
  SET_VECTOR_ELT(contents, 652, waning_tmp);
  SEXP nms = PROTECT(allocVector(STRSXP, 653));
  ...
  SET_STRING_ELT(nms, 4, mkChar("D_ini"));
  SET_STRING_ELT(nms, 5, mkChar("Ea_ini"));
  SET_STRING_ELT(nms, 6, mkChar("Es_ini"));
  SET_STRING_ELT(nms, 7, mkChar("H_ini"));
  SET_STRING_ELT(nms, 8, mkChar("ICU_H_ini"));
  SET_STRING_ELT(nms, 9, mkChar("ICU_P_ini"));
  SET_STRING_ELT(nms, 10, mkChar("ICU_R_ini"));
  SET_STRING_ELT(nms, 11, mkChar("I_imp_ini"));
  SET_STRING_ELT(nms, 12, mkChar("I_ini"));
  SET_STRING_ELT(nms, 13, mkChar("N"));
  SET_STRING_ELT(nms, 14, mkChar("N_imp"));
  SET_STRING_ELT(nms, 15, mkChar("N_imp_non_zero"));
  SET_STRING_ELT(nms, 16, mkChar("N_steps"));
  SET_STRING_ELT(nms, 17, mkChar("P_ini"));
  SET_STRING_ELT(nms, 18, mkChar("R_ini"));
  SET_STRING_ELT(nms, 19, mkChar("S_ini"));
  SET_STRING_ELT(nms, 20, mkChar("T_waning"));
  SET_STRING_ELT(nms, 21, mkChar("asympt_frac"));
  SET_STRING_ELT(nms, 22, mkChar("asympt_infect"));
  SET_STRING_ELT(nms, 23, mkChar("beta"));
  SET_STRING_ELT(nms, 24, mkChar("beta_day"));
  SET_STRING_ELT(nms, 25, mkChar("beta_int"));
  SET_STRING_ELT(nms, 26, mkChar("beta_mode"));
  SET_STRING_ELT(nms, 27, mkChar("beta_norm"));
  SET_STRING_ELT(nms, 28, mkChar("beta_reduction"));
  SET_STRING_ELT(nms, 29, mkChar("beta_spont_behaviour"));
  SET_STRING_ELT(nms, 30, mkChar("beta_strain"));
  SET_STRING_ELT(nms, 31, mkChar("contact_change"));
  SET_STRING_ELT(nms, 32, mkChar("cross_protection"));
  SET_STRING_ELT(nms, 33, mkChar("dim_A"));
  SET_STRING_ELT(nms, 34, mkChar("dim_A_1"));
  SET_STRING_ELT(nms, 35, mkChar("dim_A_12"));
  SET_STRING_ELT(nms, 36, mkChar("dim_A_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_A_3"));
  SET_STRING_ELT(nms, 38, mkChar("dim_A_ini"));
  SET_STRING_ELT(nms, 39, mkChar("dim_A_ini_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_A_ini_12"));
  SET_STRING_ELT(nms, 41, mkChar("dim_A_ini_2"));
  SET_STRING_ELT(nms, 42, mkChar("dim_A_ini_3"));
  SET_STRING_ELT(nms, 43, mkChar("dim_B_D"));
  SET_STRING_ELT(nms, 44, mkChar("dim_B_D_1"));
  SET_STRING_ELT(nms, 45, mkChar("dim_B_D_12"));
  SET_STRING_ELT(nms, 46, mkChar("dim_B_D_2"));
  SET_STRING_ELT(nms, 47, mkChar("dim_B_D_3"));
  SET_STRING_ELT(nms, 48, mkChar("dim_B_D_H"));
  SET_STRING_ELT(nms, 49, mkChar("dim_B_D_H_1"));
  SET_STRING_ELT(nms, 50, mkChar("dim_B_D_H_12"));
  SET_STRING_ELT(nms, 51, mkChar("dim_B_D_H_2"));
  SET_STRING_ELT(nms, 52, mkChar("dim_B_D_H_3"));
  SET_STRING_ELT(nms, 53, mkChar("dim_B_D_H_ini"));
  SET_STRING_ELT(nms, 54, mkChar("dim_B_D_H_ini_1"));
  SET_STRING_ELT(nms, 55, mkChar("dim_B_D_H_ini_12"));
  SET_STRING_ELT(nms, 56, mkChar("dim_B_D_H_ini_2"));
  SET_STRING_ELT(nms, 57, mkChar("dim_B_D_H_ini_3"));
  SET_STRING_ELT(nms, 58, mkChar("dim_B_D_ICU"));
  SET_STRING_ELT(nms, 59, mkChar("dim_B_D_ICU_1"));
  SET_STRING_ELT(nms, 60, mkChar("dim_B_D_ICU_12"));
  SET_STRING_ELT(nms, 61, mkChar("dim_B_D_ICU_2"));
  SET_STRING_ELT(nms, 62, mkChar("dim_B_D_ICU_3"));
  SET_STRING_ELT(nms, 63, mkChar("dim_B_D_ICU_ini"));
  SET_STRING_ELT(nms, 64, mkChar("dim_B_D_ICU_ini_1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_B_D_ICU_ini_12"));
  SET_STRING_ELT(nms, 66, mkChar("dim_B_D_ICU_ini_2"));
  SET_STRING_ELT(nms, 67, mkChar("dim_B_D_ICU_ini_3"));
  SET_STRING_ELT(nms, 68, mkChar("dim_B_D_ini"));
  SET_STRING_ELT(nms, 69, mkChar("dim_B_D_ini_1"));
  SET_STRING_ELT(nms, 70, mkChar("dim_B_D_ini_12"));
  SET_STRING_ELT(nms, 71, mkChar("dim_B_D_ini_2"));
  SET_STRING_ELT(nms, 72, mkChar("dim_B_D_ini_3"));
  SET_STRING_ELT(nms, 73, mkChar("dim_D"));
  SET_STRING_ELT(nms, 74, mkChar("dim_D_1"));
  SET_STRING_ELT(nms, 75, mkChar("dim_D_12"));
  SET_STRING_ELT(nms, 76, mkChar("dim_D_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_D_3"));
  SET_STRING_ELT(nms, 78, mkChar("dim_D_ini"));
  SET_STRING_ELT(nms, 79, mkChar("dim_D_ini_1"));
  SET_STRING_ELT(nms, 80, mkChar("dim_D_ini_12"));
  SET_STRING_ELT(nms, 81, mkChar("dim_D_ini_2"));
  SET_STRING_ELT(nms, 82, mkChar("dim_D_ini_3"));
  SET_STRING_ELT(nms, 83, mkChar("dim_Ea"));
  SET_STRING_ELT(nms, 84, mkChar("dim_Ea_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_Ea_12"));
  SET_STRING_ELT(nms, 86, mkChar("dim_Ea_2"));
  SET_STRING_ELT(nms, 87, mkChar("dim_Ea_3"));
  SET_STRING_ELT(nms, 88, mkChar("dim_Ea_ini"));
  SET_STRING_ELT(nms, 89, mkChar("dim_Ea_ini_1"));
  SET_STRING_ELT(nms, 90, mkChar("dim_Ea_ini_12"));
  SET_STRING_ELT(nms, 91, mkChar("dim_Ea_ini_2"));
  SET_STRING_ELT(nms, 92, mkChar("dim_Ea_ini_3"));
  SET_STRING_ELT(nms, 93, mkChar("dim_Es"));
  SET_STRING_ELT(nms, 94, mkChar("dim_Es_1"));
  SET_STRING_ELT(nms, 95, mkChar("dim_Es_12"));
  SET_STRING_ELT(nms, 96, mkChar("dim_Es_2"));
  SET_STRING_ELT(nms, 97, mkChar("dim_Es_3"));
  SET_STRING_ELT(nms, 98, mkChar("dim_Es_ini"));
  SET_STRING_ELT(nms, 99, mkChar("dim_Es_ini_1"));
  SET_STRING_ELT(nms, 100, mkChar("dim_Es_ini_12"));
  SET_STRING_ELT(nms, 101, mkChar("dim_Es_ini_2"));
  SET_STRING_ELT(nms, 102, mkChar("dim_Es_ini_3"));
  SET_STRING_ELT(nms, 103, mkChar("dim_H"));
  SET_STRING_ELT(nms, 104, mkChar("dim_H_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_H_12"));
  SET_STRING_ELT(nms, 106, mkChar("dim_H_2"));
  SET_STRING_ELT(nms, 107, mkChar("dim_H_3"));
  SET_STRING_ELT(nms, 108, mkChar("dim_H_ini"));
  SET_STRING_ELT(nms, 109, mkChar("dim_H_ini_1"));
  SET_STRING_ELT(nms, 110, mkChar("dim_H_ini_12"));
  SET_STRING_ELT(nms, 111, mkChar("dim_H_ini_2"));
  SET_STRING_ELT(nms, 112, mkChar("dim_H_ini_3"));
  SET_STRING_ELT(nms, 113, mkChar("dim_I"));
  SET_STRING_ELT(nms, 114, mkChar("dim_ICU_H"));
  SET_STRING_ELT(nms, 115, mkChar("dim_ICU_H_1"));
  SET_STRING_ELT(nms, 116, mkChar("dim_ICU_H_12"));
  SET_STRING_ELT(nms, 117, mkChar("dim_ICU_H_2"));
  SET_STRING_ELT(nms, 118, mkChar("dim_ICU_H_3"));
  SET_STRING_ELT(nms, 119, mkChar("dim_ICU_H_ini"));
  SET_STRING_ELT(nms, 120, mkChar("dim_ICU_H_ini_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_ICU_H_ini_12"));
  SET_STRING_ELT(nms, 122, mkChar("dim_ICU_H_ini_2"));
  SET_STRING_ELT(nms, 123, mkChar("dim_ICU_H_ini_3"));
  SET_STRING_ELT(nms, 124, mkChar("dim_ICU_P"));
  SET_STRING_ELT(nms, 125, mkChar("dim_ICU_P_1"));
  SET_STRING_ELT(nms, 126, mkChar("dim_ICU_P_12"));
  SET_STRING_ELT(nms, 127, mkChar("dim_ICU_P_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_ICU_P_3"));
  SET_STRING_ELT(nms, 129, mkChar("dim_ICU_P_ini"));
  SET_STRING_ELT(nms, 130, mkChar("dim_ICU_P_ini_1"));
  SET_STRING_ELT(nms, 131, mkChar("dim_ICU_P_ini_12"));
  SET_STRING_ELT(nms, 132, mkChar("dim_ICU_P_ini_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_ICU_P_ini_3"));
  SET_STRING_ELT(nms, 134, mkChar("dim_ICU_R"));
  SET_STRING_ELT(nms, 135, mkChar("dim_ICU_R_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_ICU_R_12"));
  SET_STRING_ELT(nms, 137, mkChar("dim_ICU_R_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_ICU_R_3"));
  SET_STRING_ELT(nms, 139, mkChar("dim_ICU_R_ini"));
  SET_STRING_ELT(nms, 140, mkChar("dim_ICU_R_ini_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_ICU_R_ini_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_ICU_R_ini_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_ICU_R_ini_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 145, mkChar("dim_I_12"));
  SET_STRING_ELT(nms, 146, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 147, mkChar("dim_I_3"));
  SET_STRING_ELT(nms, 148, mkChar("dim_I_imp_ini"));
  SET_STRING_ELT(nms, 149, mkChar("dim_I_imp_ini_1"));
  SET_STRING_ELT(nms, 150, mkChar("dim_I_imp_ini_12"));
  SET_STRING_ELT(nms, 151, mkChar("dim_I_imp_ini_2"));
  SET_STRING_ELT(nms, 152, mkChar("dim_I_imp_ini_3"));
  SET_STRING_ELT(nms, 153, mkChar("dim_I_ini"));
  SET_STRING_ELT(nms, 154, mkChar("dim_I_ini_1"));
  SET_STRING_ELT(nms, 155, mkChar("dim_I_ini_12"));
  SET_STRING_ELT(nms, 156, mkChar("dim_I_ini_2"));
  SET_STRING_ELT(nms, 157, mkChar("dim_I_ini_3"));
  SET_STRING_ELT(nms, 158, mkChar("dim_N"));
  SET_STRING_ELT(nms, 159, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 160, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 161, mkChar("dim_N_imp"));
  SET_STRING_ELT(nms, 162, mkChar("dim_N_imp_1"));
  SET_STRING_ELT(nms, 163, mkChar("dim_N_imp_12"));
  SET_STRING_ELT(nms, 164, mkChar("dim_N_imp_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_N_imp_3"));
  SET_STRING_ELT(nms, 166, mkChar("dim_N_imp_non_zero"));
  SET_STRING_ELT(nms, 167, mkChar("dim_N_imp_non_zero_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_N_imp_non_zero_12"));
  SET_STRING_ELT(nms, 169, mkChar("dim_N_imp_non_zero_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_N_imp_non_zero_3"));
  SET_STRING_ELT(nms, 171, mkChar("dim_P"));
  SET_STRING_ELT(nms, 172, mkChar("dim_P_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_P_12"));
  SET_STRING_ELT(nms, 174, mkChar("dim_P_2"));
  SET_STRING_ELT(nms, 175, mkChar("dim_P_3"));
  SET_STRING_ELT(nms, 176, mkChar("dim_P_ini"));
  SET_STRING_ELT(nms, 177, mkChar("dim_P_ini_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_P_ini_12"));
  SET_STRING_ELT(nms, 179, mkChar("dim_P_ini_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_P_ini_3"));
  SET_STRING_ELT(nms, 181, mkChar("dim_R"));
  SET_STRING_ELT(nms, 182, mkChar("dim_R_1"));
  SET_STRING_ELT(nms, 183, mkChar("dim_R_12"));
  SET_STRING_ELT(nms, 184, mkChar("dim_R_2"));
  SET_STRING_ELT(nms, 185, mkChar("dim_R_3"));
  SET_STRING_ELT(nms, 186, mkChar("dim_R_ini"));
  SET_STRING_ELT(nms, 187, mkChar("dim_R_ini_1"));
  SET_STRING_ELT(nms, 188, mkChar("dim_R_ini_12"));
  SET_STRING_ELT(nms, 189, mkChar("dim_R_ini_2"));
  SET_STRING_ELT(nms, 190, mkChar("dim_R_ini_3"));
  SET_STRING_ELT(nms, 191, mkChar("dim_S"));
  SET_STRING_ELT(nms, 192, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 193, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 194, mkChar("dim_S_ini"));
  SET_STRING_ELT(nms, 195, mkChar("dim_S_ini_1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_S_ini_2"));
  SET_STRING_ELT(nms, 197, mkChar("dim_T_waning"));
  SET_STRING_ELT(nms, 198, mkChar("dim_T_waning_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_T_waning_2"));
  SET_STRING_ELT(nms, 200, mkChar("dim_asympt_frac"));
  SET_STRING_ELT(nms, 201, mkChar("dim_asympt_frac_1"));
  SET_STRING_ELT(nms, 202, mkChar("dim_asympt_frac_12"));
  SET_STRING_ELT(nms, 203, mkChar("dim_asympt_frac_2"));
  SET_STRING_ELT(nms, 204, mkChar("dim_asympt_frac_3"));
  SET_STRING_ELT(nms, 205, mkChar("dim_beta"));
  SET_STRING_ELT(nms, 206, mkChar("dim_beta_1"));
  SET_STRING_ELT(nms, 207, mkChar("dim_beta_2"));
  SET_STRING_ELT(nms, 208, mkChar("dim_beta_day"));
  SET_STRING_ELT(nms, 209, mkChar("dim_beta_day_1"));
  SET_STRING_ELT(nms, 210, mkChar("dim_beta_day_2"));
  SET_STRING_ELT(nms, 211, mkChar("dim_beta_int"));
  SET_STRING_ELT(nms, 212, mkChar("dim_beta_norm"));
  SET_STRING_ELT(nms, 213, mkChar("dim_beta_reduction"));
  SET_STRING_ELT(nms, 214, mkChar("dim_beta_reduction_1"));
  SET_STRING_ELT(nms, 215, mkChar("dim_beta_reduction_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_beta_spont_behaviour"));
  SET_STRING_ELT(nms, 217, mkChar("dim_beta_spont_behaviour_1"));
  SET_STRING_ELT(nms, 218, mkChar("dim_beta_spont_behaviour_2"));
  SET_STRING_ELT(nms, 219, mkChar("dim_beta_strain"));
  SET_STRING_ELT(nms, 220, mkChar("dim_contact_change"));
  SET_STRING_ELT(nms, 221, mkChar("dim_contact_change_1"));
  SET_STRING_ELT(nms, 222, mkChar("dim_contact_change_2"));
  SET_STRING_ELT(nms, 223, mkChar("dim_cross_protection"));
  SET_STRING_ELT(nms, 224, mkChar("dim_cross_protection_1"));
  SET_STRING_ELT(nms, 225, mkChar("dim_cross_protection_2"));
  SET_STRING_ELT(nms, 226, mkChar("dim_expected_health_loss"));
  SET_STRING_ELT(nms, 227, mkChar("dim_expected_health_loss_1"));
  SET_STRING_ELT(nms, 228, mkChar("dim_expected_health_loss_2"));
  SET_STRING_ELT(nms, 229, mkChar("dim_hosp_prob"));
  SET_STRING_ELT(nms, 230, mkChar("dim_hosp_prob_1"));
  SET_STRING_ELT(nms, 231, mkChar("dim_hosp_prob_12"));
  SET_STRING_ELT(nms, 232, mkChar("dim_hosp_prob_2"));
  SET_STRING_ELT(nms, 233, mkChar("dim_hosp_prob_3"));
  SET_STRING_ELT(nms, 234, mkChar("dim_icu_prob"));
  SET_STRING_ELT(nms, 235, mkChar("dim_icu_prob_1"));
  SET_STRING_ELT(nms, 236, mkChar("dim_icu_prob_12"));
  SET_STRING_ELT(nms, 237, mkChar("dim_icu_prob_2"));
  SET_STRING_ELT(nms, 238, mkChar("dim_icu_prob_3"));
  SET_STRING_ELT(nms, 239, mkChar("dim_import_vec"));
  SET_STRING_ELT(nms, 240, mkChar("dim_import_vec_1"));
  SET_STRING_ELT(nms, 241, mkChar("dim_import_vec_12"));
  SET_STRING_ELT(nms, 242, mkChar("dim_import_vec_123"));
  SET_STRING_ELT(nms, 243, mkChar("dim_import_vec_2"));
  SET_STRING_ELT(nms, 244, mkChar("dim_import_vec_3"));
  SET_STRING_ELT(nms, 245, mkChar("dim_import_vec_4"));
  SET_STRING_ELT(nms, 246, mkChar("dim_index"));
  SET_STRING_ELT(nms, 247, mkChar("dim_interpolation_time"));
  SET_STRING_ELT(nms, 248, mkChar("dim_kernel"));
  SET_STRING_ELT(nms, 249, mkChar("dim_kernel_1"));
  SET_STRING_ELT(nms, 250, mkChar("dim_kernel_2"));
  SET_STRING_ELT(nms, 251, mkChar("dim_lambda_ij"));
  SET_STRING_ELT(nms, 252, mkChar("dim_lambda_ij_1"));
  SET_STRING_ELT(nms, 253, mkChar("dim_lambda_ij_12"));
  SET_STRING_ELT(nms, 254, mkChar("dim_lambda_ij_123"));
  SET_STRING_ELT(nms, 255, mkChar("dim_lambda_ij_1234"));
  SET_STRING_ELT(nms, 256, mkChar("dim_lambda_ij_2"));
  SET_STRING_ELT(nms, 257, mkChar("dim_lambda_ij_3"));
  SET_STRING_ELT(nms, 258, mkChar("dim_lambda_ij_4"));
  SET_STRING_ELT(nms, 259, mkChar("dim_lambda_ij_5"));
  SET_STRING_ELT(nms, 260, mkChar("dim_length_hosp"));
  SET_STRING_ELT(nms, 261, mkChar("dim_length_hosp_1"));
  SET_STRING_ELT(nms, 262, mkChar("dim_length_hosp_12"));
  SET_STRING_ELT(nms, 263, mkChar("dim_length_hosp_2"));
  SET_STRING_ELT(nms, 264, mkChar("dim_length_hosp_3"));
  SET_STRING_ELT(nms, 265, mkChar("dim_length_icu"));
  SET_STRING_ELT(nms, 266, mkChar("dim_length_icu_1"));
  SET_STRING_ELT(nms, 267, mkChar("dim_length_icu_12"));
  SET_STRING_ELT(nms, 268, mkChar("dim_length_icu_2"));
  SET_STRING_ELT(nms, 269, mkChar("dim_length_icu_3"));
  SET_STRING_ELT(nms, 270, mkChar("dim_mixing_matrix"));
  SET_STRING_ELT(nms, 271, mkChar("dim_mixing_matrix_1"));
  SET_STRING_ELT(nms, 272, mkChar("dim_mixing_matrix_2"));
  SET_STRING_ELT(nms, 273, mkChar("dim_n_AR"));
  SET_STRING_ELT(nms, 274, mkChar("dim_n_AR_1"));
  SET_STRING_ELT(nms, 275, mkChar("dim_n_AR_12"));
  SET_STRING_ELT(nms, 276, mkChar("dim_n_AR_2"));
  SET_STRING_ELT(nms, 277, mkChar("dim_n_AR_3"));
  SET_STRING_ELT(nms, 278, mkChar("dim_n_B_D_D"));
  SET_STRING_ELT(nms, 279, mkChar("dim_n_B_D_D_1"));
  SET_STRING_ELT(nms, 280, mkChar("dim_n_B_D_D_12"));
  SET_STRING_ELT(nms, 281, mkChar("dim_n_B_D_D_2"));
  SET_STRING_ELT(nms, 282, mkChar("dim_n_B_D_D_3"));
  SET_STRING_ELT(nms, 283, mkChar("dim_n_B_H_D"));
  SET_STRING_ELT(nms, 284, mkChar("dim_n_B_H_D_1"));
  SET_STRING_ELT(nms, 285, mkChar("dim_n_B_H_D_12"));
  SET_STRING_ELT(nms, 286, mkChar("dim_n_B_H_D_2"));
  SET_STRING_ELT(nms, 287, mkChar("dim_n_B_H_D_3"));
  SET_STRING_ELT(nms, 288, mkChar("dim_n_B_ICU_D"));
  SET_STRING_ELT(nms, 289, mkChar("dim_n_B_ICU_D_1"));
  SET_STRING_ELT(nms, 290, mkChar("dim_n_B_ICU_D_12"));
  SET_STRING_ELT(nms, 291, mkChar("dim_n_B_ICU_D_2"));
  SET_STRING_ELT(nms, 292, mkChar("dim_n_B_ICU_D_3"));
  SET_STRING_ELT(nms, 293, mkChar("dim_n_EaA"));
  SET_STRING_ELT(nms, 294, mkChar("dim_n_EaA_1"));
  SET_STRING_ELT(nms, 295, mkChar("dim_n_EaA_12"));
  SET_STRING_ELT(nms, 296, mkChar("dim_n_EaA_2"));
  SET_STRING_ELT(nms, 297, mkChar("dim_n_EaA_3"));
  SET_STRING_ELT(nms, 298, mkChar("dim_n_EsI"));
  SET_STRING_ELT(nms, 299, mkChar("dim_n_EsI_1"));
  SET_STRING_ELT(nms, 300, mkChar("dim_n_EsI_12"));
  SET_STRING_ELT(nms, 301, mkChar("dim_n_EsI_2"));
  SET_STRING_ELT(nms, 302, mkChar("dim_n_EsI_3"));
  SET_STRING_ELT(nms, 303, mkChar("dim_n_H"));
  SET_STRING_ELT(nms, 304, mkChar("dim_n_HD"));
  SET_STRING_ELT(nms, 305, mkChar("dim_n_HD_1"));
  SET_STRING_ELT(nms, 306, mkChar("dim_n_HD_12"));
  SET_STRING_ELT(nms, 307, mkChar("dim_n_HD_2"));
  SET_STRING_ELT(nms, 308, mkChar("dim_n_HD_3"));
  SET_STRING_ELT(nms, 309, mkChar("dim_n_HR"));
  SET_STRING_ELT(nms, 310, mkChar("dim_n_HR_1"));
  SET_STRING_ELT(nms, 311, mkChar("dim_n_HR_12"));
  SET_STRING_ELT(nms, 312, mkChar("dim_n_HR_2"));
  SET_STRING_ELT(nms, 313, mkChar("dim_n_HR_3"));
  SET_STRING_ELT(nms, 314, mkChar("dim_n_H_1"));
  SET_STRING_ELT(nms, 315, mkChar("dim_n_H_12"));
  SET_STRING_ELT(nms, 316, mkChar("dim_n_H_2"));
  SET_STRING_ELT(nms, 317, mkChar("dim_n_H_3"));
  SET_STRING_ELT(nms, 318, mkChar("dim_n_I"));
  SET_STRING_ELT(nms, 319, mkChar("dim_n_ICU_D"));
  SET_STRING_ELT(nms, 320, mkChar("dim_n_ICU_D_1"));
  SET_STRING_ELT(nms, 321, mkChar("dim_n_ICU_D_12"));
  SET_STRING_ELT(nms, 322, mkChar("dim_n_ICU_D_2"));
  SET_STRING_ELT(nms, 323, mkChar("dim_n_ICU_D_3"));
  SET_STRING_ELT(nms, 324, mkChar("dim_n_ICU_HR"));
  SET_STRING_ELT(nms, 325, mkChar("dim_n_ICU_HR_1"));
  SET_STRING_ELT(nms, 326, mkChar("dim_n_ICU_HR_12"));
  SET_STRING_ELT(nms, 327, mkChar("dim_n_ICU_HR_2"));
  SET_STRING_ELT(nms, 328, mkChar("dim_n_ICU_HR_3"));
  SET_STRING_ELT(nms, 329, mkChar("dim_n_ICU_P"));
  SET_STRING_ELT(nms, 330, mkChar("dim_n_ICU_P_1"));
  SET_STRING_ELT(nms, 331, mkChar("dim_n_ICU_P_12"));
  SET_STRING_ELT(nms, 332, mkChar("dim_n_ICU_P_2"));
  SET_STRING_ELT(nms, 333, mkChar("dim_n_ICU_P_3"));
  SET_STRING_ELT(nms, 334, mkChar("dim_n_ICU_R"));
  SET_STRING_ELT(nms, 335, mkChar("dim_n_ICU_RP"));
  SET_STRING_ELT(nms, 336, mkChar("dim_n_ICU_RP_1"));
  SET_STRING_ELT(nms, 337, mkChar("dim_n_ICU_RP_12"));
  SET_STRING_ELT(nms, 338, mkChar("dim_n_ICU_RP_2"));
  SET_STRING_ELT(nms, 339, mkChar("dim_n_ICU_RP_3"));
  SET_STRING_ELT(nms, 340, mkChar("dim_n_ICU_R_1"));
  SET_STRING_ELT(nms, 341, mkChar("dim_n_ICU_R_12"));
  SET_STRING_ELT(nms, 342, mkChar("dim_n_ICU_R_2"));
  SET_STRING_ELT(nms, 343, mkChar("dim_n_ICU_R_3"));
  SET_STRING_ELT(nms, 344, mkChar("dim_n_ID"));
  SET_STRING_ELT(nms, 345, mkChar("dim_n_ID_1"));
  SET_STRING_ELT(nms, 346, mkChar("dim_n_ID_12"));
  SET_STRING_ELT(nms, 347, mkChar("dim_n_ID_2"));
  SET_STRING_ELT(nms, 348, mkChar("dim_n_ID_3"));
  SET_STRING_ELT(nms, 349, mkChar("dim_n_IH"));
  SET_STRING_ELT(nms, 350, mkChar("dim_n_IH_1"));
  SET_STRING_ELT(nms, 351, mkChar("dim_n_IH_12"));
  SET_STRING_ELT(nms, 352, mkChar("dim_n_IH_2"));
  SET_STRING_ELT(nms, 353, mkChar("dim_n_IH_3"));
  SET_STRING_ELT(nms, 354, mkChar("dim_n_IICU"));
  SET_STRING_ELT(nms, 355, mkChar("dim_n_IICU_1"));
  SET_STRING_ELT(nms, 356, mkChar("dim_n_IICU_12"));
  SET_STRING_ELT(nms, 357, mkChar("dim_n_IICU_2"));
  SET_STRING_ELT(nms, 358, mkChar("dim_n_IICU_3"));
  SET_STRING_ELT(nms, 359, mkChar("dim_n_IR"));
  SET_STRING_ELT(nms, 360, mkChar("dim_n_IR_1"));
  SET_STRING_ELT(nms, 361, mkChar("dim_n_IR_12"));
  SET_STRING_ELT(nms, 362, mkChar("dim_n_IR_2"));
  SET_STRING_ELT(nms, 363, mkChar("dim_n_IR_3"));
  SET_STRING_ELT(nms, 364, mkChar("dim_n_I_1"));
  SET_STRING_ELT(nms, 365, mkChar("dim_n_I_12"));
  SET_STRING_ELT(nms, 366, mkChar("dim_n_I_2"));
  SET_STRING_ELT(nms, 367, mkChar("dim_n_I_3"));
  SET_STRING_ELT(nms, 368, mkChar("dim_n_PI"));
  SET_STRING_ELT(nms, 369, mkChar("dim_n_PI_1"));
  SET_STRING_ELT(nms, 370, mkChar("dim_n_PI_12"));
  SET_STRING_ELT(nms, 371, mkChar("dim_n_PI_2"));
  SET_STRING_ELT(nms, 372, mkChar("dim_n_PI_3"));
  SET_STRING_ELT(nms, 373, mkChar("dim_n_RS"));
  SET_STRING_ELT(nms, 374, mkChar("dim_n_RS_1"));
  SET_STRING_ELT(nms, 375, mkChar("dim_n_RS_12"));
  SET_STRING_ELT(nms, 376, mkChar("dim_n_RS_2"));
  SET_STRING_ELT(nms, 377, mkChar("dim_n_RS_3"));
  SET_STRING_ELT(nms, 378, mkChar("dim_n_SE"));
  SET_STRING_ELT(nms, 379, mkChar("dim_n_SE_1"));
  SET_STRING_ELT(nms, 380, mkChar("dim_n_SE_12"));
  SET_STRING_ELT(nms, 381, mkChar("dim_n_SE_2"));
  SET_STRING_ELT(nms, 382, mkChar("dim_n_SE_3"));
  SET_STRING_ELT(nms, 383, mkChar("dim_n_SE_tot"));
  SET_STRING_ELT(nms, 384, mkChar("dim_n_SE_tot_1"));
  SET_STRING_ELT(nms, 385, mkChar("dim_n_SE_tot_2"));
  SET_STRING_ELT(nms, 386, mkChar("dim_n_SEa"));
  SET_STRING_ELT(nms, 387, mkChar("dim_n_SEa_1"));
  SET_STRING_ELT(nms, 388, mkChar("dim_n_SEa_12"));
  SET_STRING_ELT(nms, 389, mkChar("dim_n_SEa_2"));
  SET_STRING_ELT(nms, 390, mkChar("dim_n_SEa_3"));
  SET_STRING_ELT(nms, 391, mkChar("dim_n_SEi"));
  SET_STRING_ELT(nms, 392, mkChar("dim_n_SEi_1"));
  SET_STRING_ELT(nms, 393, mkChar("dim_n_SEi_12"));
  SET_STRING_ELT(nms, 394, mkChar("dim_n_SEi_2"));
  SET_STRING_ELT(nms, 395, mkChar("dim_n_SEi_3"));
  SET_STRING_ELT(nms, 396, mkChar("dim_n_vac_help"));
  SET_STRING_ELT(nms, 397, mkChar("dim_n_vac_help_1"));
  SET_STRING_ELT(nms, 398, mkChar("dim_n_vac_help_2"));
  SET_STRING_ELT(nms, 399, mkChar("dim_n_vac_now"));
  SET_STRING_ELT(nms, 400, mkChar("dim_n_vac_now_1"));
  SET_STRING_ELT(nms, 401, mkChar("dim_n_vac_now_2"));
  SET_STRING_ELT(nms, 402, mkChar("dim_p_SE"));
  SET_STRING_ELT(nms, 403, mkChar("dim_p_SE_1"));
  SET_STRING_ELT(nms, 404, mkChar("dim_p_SE_12"));
  SET_STRING_ELT(nms, 405, mkChar("dim_p_SE_2"));
  SET_STRING_ELT(nms, 406, mkChar("dim_p_SE_3"));
  SET_STRING_ELT(nms, 407, mkChar("dim_pa"));
  SET_STRING_ELT(nms, 408, mkChar("dim_pa_1"));
  SET_STRING_ELT(nms, 409, mkChar("dim_pa_12"));
  SET_STRING_ELT(nms, 410, mkChar("dim_pa_2"));
  SET_STRING_ELT(nms, 411, mkChar("dim_pa_3"));
  SET_STRING_ELT(nms, 412, mkChar("dim_post_icu"));
  SET_STRING_ELT(nms, 413, mkChar("dim_post_icu_1"));
  SET_STRING_ELT(nms, 414, mkChar("dim_post_icu_12"));
  SET_STRING_ELT(nms, 415, mkChar("dim_post_icu_2"));
  SET_STRING_ELT(nms, 416, mkChar("dim_post_icu_3"));
  SET_STRING_ELT(nms, 417, mkChar("dim_pre_icu"));
  SET_STRING_ELT(nms, 418, mkChar("dim_pre_icu_1"));
  SET_STRING_ELT(nms, 419, mkChar("dim_pre_icu_12"));
  SET_STRING_ELT(nms, 420, mkChar("dim_pre_icu_2"));
  SET_STRING_ELT(nms, 421, mkChar("dim_pre_icu_3"));
  SET_STRING_ELT(nms, 422, mkChar("dim_prob_death_hosp"));
  SET_STRING_ELT(nms, 423, mkChar("dim_prob_death_hosp_1"));
  SET_STRING_ELT(nms, 424, mkChar("dim_prob_death_hosp_12"));
  SET_STRING_ELT(nms, 425, mkChar("dim_prob_death_hosp_2"));
  SET_STRING_ELT(nms, 426, mkChar("dim_prob_death_hosp_3"));
  SET_STRING_ELT(nms, 427, mkChar("dim_prob_death_icu"));
  SET_STRING_ELT(nms, 428, mkChar("dim_prob_death_icu_1"));
  SET_STRING_ELT(nms, 429, mkChar("dim_prob_death_icu_12"));
  SET_STRING_ELT(nms, 430, mkChar("dim_prob_death_icu_2"));
  SET_STRING_ELT(nms, 431, mkChar("dim_prob_death_icu_3"));
  SET_STRING_ELT(nms, 432, mkChar("dim_prob_death_non_hosp"));
  SET_STRING_ELT(nms, 433, mkChar("dim_prob_death_non_hosp_1"));
  SET_STRING_ELT(nms, 434, mkChar("dim_prob_death_non_hosp_12"));
  SET_STRING_ELT(nms, 435, mkChar("dim_prob_death_non_hosp_2"));
  SET_STRING_ELT(nms, 436, mkChar("dim_prob_death_non_hosp_3"));
  SET_STRING_ELT(nms, 437, mkChar("dim_spont_behav_change_params"));
  SET_STRING_ELT(nms, 438, mkChar("dim_susceptibility_asymp"));
  SET_STRING_ELT(nms, 439, mkChar("dim_susceptibility_asymp_1"));
  SET_STRING_ELT(nms, 440, mkChar("dim_susceptibility_asymp_12"));
  SET_STRING_ELT(nms, 441, mkChar("dim_susceptibility_asymp_2"));
  SET_STRING_ELT(nms, 442, mkChar("dim_susceptibility_asymp_3"));
  SET_STRING_ELT(nms, 443, mkChar("dim_susceptibility_symp"));
  SET_STRING_ELT(nms, 444, mkChar("dim_susceptibility_symp_1"));
  SET_STRING_ELT(nms, 445, mkChar("dim_susceptibility_symp_12"));
  SET_STRING_ELT(nms, 446, mkChar("dim_susceptibility_symp_2"));
  SET_STRING_ELT(nms, 447, mkChar("dim_susceptibility_symp_3"));
  SET_STRING_ELT(nms, 448, mkChar("dim_symp_asymp_effect"));
  SET_STRING_ELT(nms, 449, mkChar("dim_symp_asymp_effect_1"));
  SET_STRING_ELT(nms, 450, mkChar("dim_symp_asymp_effect_12"));
  SET_STRING_ELT(nms, 451, mkChar("dim_symp_asymp_effect_2"));
  SET_STRING_ELT(nms, 452, mkChar("dim_symp_asymp_effect_3"));
  SET_STRING_ELT(nms, 453, mkChar("dim_symp_trans"));
  SET_STRING_ELT(nms, 454, mkChar("dim_symp_trans_1"));
  SET_STRING_ELT(nms, 455, mkChar("dim_symp_trans_12"));
  SET_STRING_ELT(nms, 456, mkChar("dim_symp_trans_2"));
  SET_STRING_ELT(nms, 457, mkChar("dim_symp_trans_3"));
  SET_STRING_ELT(nms, 458, mkChar("dim_sympt_frac"));
  SET_STRING_ELT(nms, 459, mkChar("dim_sympt_frac_1"));
  SET_STRING_ELT(nms, 460, mkChar("dim_sympt_frac_12"));
  SET_STRING_ELT(nms, 461, mkChar("dim_sympt_frac_2"));
  SET_STRING_ELT(nms, 462, mkChar("dim_sympt_frac_3"));
  SET_STRING_ELT(nms, 463, mkChar("dim_tot_hosp"));
  SET_STRING_ELT(nms, 464, mkChar("dim_tot_hosp_1"));
  SET_STRING_ELT(nms, 465, mkChar("dim_tot_hosp_12"));
  SET_STRING_ELT(nms, 466, mkChar("dim_tot_hosp_2"));
  SET_STRING_ELT(nms, 467, mkChar("dim_tot_hosp_3"));
  SET_STRING_ELT(nms, 468, mkChar("dim_tot_hosp_ini"));
  SET_STRING_ELT(nms, 469, mkChar("dim_tot_hosp_ini_1"));
  SET_STRING_ELT(nms, 470, mkChar("dim_tot_hosp_ini_12"));
  SET_STRING_ELT(nms, 471, mkChar("dim_tot_hosp_ini_2"));
  SET_STRING_ELT(nms, 472, mkChar("dim_tot_hosp_ini_3"));
  SET_STRING_ELT(nms, 473, mkChar("dim_tot_infected"));
  SET_STRING_ELT(nms, 474, mkChar("dim_tot_infected_1"));
  SET_STRING_ELT(nms, 475, mkChar("dim_tot_infected_12"));
  SET_STRING_ELT(nms, 476, mkChar("dim_tot_infected_2"));
  SET_STRING_ELT(nms, 477, mkChar("dim_tot_infected_3"));
  SET_STRING_ELT(nms, 478, mkChar("dim_tot_infected_ini"));
  SET_STRING_ELT(nms, 479, mkChar("dim_tot_infected_ini_1"));
  SET_STRING_ELT(nms, 480, mkChar("dim_tot_infected_ini_12"));
  SET_STRING_ELT(nms, 481, mkChar("dim_tot_infected_ini_2"));
  SET_STRING_ELT(nms, 482, mkChar("dim_tot_infected_ini_3"));
  SET_STRING_ELT(nms, 483, mkChar("dim_tot_resp"));
  SET_STRING_ELT(nms, 484, mkChar("dim_tot_resp_1"));
  SET_STRING_ELT(nms, 485, mkChar("dim_tot_resp_12"));
  SET_STRING_ELT(nms, 486, mkChar("dim_tot_resp_2"));
  SET_STRING_ELT(nms, 487, mkChar("dim_tot_resp_3"));
  SET_STRING_ELT(nms, 488, mkChar("dim_tot_resp_ini"));
  SET_STRING_ELT(nms, 489, mkChar("dim_tot_resp_ini_1"));
  SET_STRING_ELT(nms, 490, mkChar("dim_tot_resp_ini_12"));
  SET_STRING_ELT(nms, 491, mkChar("dim_tot_resp_ini_2"));
  SET_STRING_ELT(nms, 492, mkChar("dim_tot_resp_ini_3"));
  SET_STRING_ELT(nms, 493, mkChar("dim_tot_vac"));
  SET_STRING_ELT(nms, 494, mkChar("dim_tot_vac_1"));
  SET_STRING_ELT(nms, 495, mkChar("dim_tot_vac_2"));
  SET_STRING_ELT(nms, 496, mkChar("dim_tot_vac_adm"));
  SET_STRING_ELT(nms, 497, mkChar("dim_tot_vac_adm_1"));
  SET_STRING_ELT(nms, 498, mkChar("dim_tot_vac_adm_2"));
  SET_STRING_ELT(nms, 499, mkChar("dim_tot_vac_adm_ini"));
  SET_STRING_ELT(nms, 500, mkChar("dim_tot_vac_adm_ini_1"));
  SET_STRING_ELT(nms, 501, mkChar("dim_tot_vac_adm_ini_2"));
  SET_STRING_ELT(nms, 502, mkChar("dim_tot_vac_ini"));
  SET_STRING_ELT(nms, 503, mkChar("dim_tot_vac_ini_1"));
  SET_STRING_ELT(nms, 504, mkChar("dim_tot_vac_ini_2"));
  SET_STRING_ELT(nms, 505, mkChar("dim_transmisibility"));
  SET_STRING_ELT(nms, 506, mkChar("dim_transmisibility_1"));
  SET_STRING_ELT(nms, 507, mkChar("dim_transmisibility_12"));
  SET_STRING_ELT(nms, 508, mkChar("dim_transmisibility_2"));
  SET_STRING_ELT(nms, 509, mkChar("dim_transmisibility_3"));
  SET_STRING_ELT(nms, 510, mkChar("dim_vaccinations"));
  SET_STRING_ELT(nms, 511, mkChar("dim_vaccinations_1"));
  SET_STRING_ELT(nms, 512, mkChar("dim_vaccinations_12"));
  SET_STRING_ELT(nms, 513, mkChar("dim_vaccinations_2"));
  SET_STRING_ELT(nms, 514, mkChar("dim_vaccinations_3"));
  SET_STRING_ELT(nms, 515, mkChar("dim_vax_time_step"));
  SET_STRING_ELT(nms, 516, mkChar("dim_vax_time_step_1"));
  SET_STRING_ELT(nms, 517, mkChar("dim_vax_time_step_2"));
  SET_STRING_ELT(nms, 518, mkChar("dim_waning_immunity_vax"));
  SET_STRING_ELT(nms, 519, mkChar("dim_waning_immunity_vax_1"));
  SET_STRING_ELT(nms, 520, mkChar("dim_waning_immunity_vax_12"));
  SET_STRING_ELT(nms, 521, mkChar("dim_waning_immunity_vax_2"));
  SET_STRING_ELT(nms, 522, mkChar("dim_waning_immunity_vax_3"));
  SET_STRING_ELT(nms, 523, mkChar("dim_waning_tmp"));
  SET_STRING_ELT(nms, 524, mkChar("dim_waning_tmp_1"));
  SET_STRING_ELT(nms, 525, mkChar("dim_waning_tmp_2"));
  SET_STRING_ELT(nms, 526, mkChar("expected_health_loss"));
  SET_STRING_ELT(nms, 527, mkChar("hosp_prob"));
  SET_STRING_ELT(nms, 528, mkChar("icu_prob"));
  SET_STRING_ELT(nms, 529, mkChar("import_vec"));
  SET_STRING_ELT(nms, 530, mkChar("incidence_steps_measurement"));
  SET_STRING_ELT(nms, 531, mkChar("include_waning"));
  SET_STRING_ELT(nms, 532, mkChar("index"));
  SET_STRING_ELT(nms, 533, mkChar("infectious_period"));
  SET_STRING_ELT(nms, 534, mkChar("initial_A"));
  SET_STRING_ELT(nms, 535, mkChar("initial_B_D"));
  SET_STRING_ELT(nms, 536, mkChar("initial_B_D_H"));
  SET_STRING_ELT(nms, 537, mkChar("initial_B_D_ICU"));
  SET_STRING_ELT(nms, 538, mkChar("initial_D"));
  SET_STRING_ELT(nms, 539, mkChar("initial_Ea"));
  SET_STRING_ELT(nms, 540, mkChar("initial_Es"));
  SET_STRING_ELT(nms, 541, mkChar("initial_H"));
  SET_STRING_ELT(nms, 542, mkChar("initial_I"));
  SET_STRING_ELT(nms, 543, mkChar("initial_ICU_H"));
  SET_STRING_ELT(nms, 544, mkChar("initial_ICU_P"));
  SET_STRING_ELT(nms, 545, mkChar("initial_ICU_R"));
  SET_STRING_ELT(nms, 546, mkChar("initial_P"));
  SET_STRING_ELT(nms, 547, mkChar("initial_R"));
  SET_STRING_ELT(nms, 548, mkChar("initial_S"));
  SET_STRING_ELT(nms, 549, mkChar("initial_tot_hosp"));
  SET_STRING_ELT(nms, 550, mkChar("initial_tot_hosp_inc"));
  SET_STRING_ELT(nms, 551, mkChar("initial_tot_infected"));
  SET_STRING_ELT(nms, 552, mkChar("initial_tot_resp"));
  SET_STRING_ELT(nms, 553, mkChar("initial_tot_vac"));
  SET_STRING_ELT(nms, 554, mkChar("initial_tot_vac_adm"));
  SET_STRING_ELT(nms, 555, mkChar("interpolate_N_imp"));
  SET_STRING_ELT(nms, 556, mkChar("interpolate_beta_int"));
  SET_STRING_ELT(nms, 557, mkChar("interpolate_vax_time_step"));
  SET_STRING_ELT(nms, 558, mkChar("interpolation_time"));
  SET_STRING_ELT(nms, 559, mkChar("kernel"));
  SET_STRING_ELT(nms, 560, mkChar("lambda_ij"));
  SET_STRING_ELT(nms, 561, mkChar("latent_period"));
  SET_STRING_ELT(nms, 562, mkChar("length_hosp"));
  SET_STRING_ELT(nms, 563, mkChar("length_icu"));
  SET_STRING_ELT(nms, 564, mkChar("log_beta_ini"));
  SET_STRING_ELT(nms, 565, mkChar("mixing_matrix"));
  SET_STRING_ELT(nms, 566, mkChar("n"));
  SET_STRING_ELT(nms, 567, mkChar("n_AR"));
  SET_STRING_ELT(nms, 568, mkChar("n_B_D_D"));
  SET_STRING_ELT(nms, 569, mkChar("n_B_H_D"));
  SET_STRING_ELT(nms, 570, mkChar("n_B_ICU_D"));
  SET_STRING_ELT(nms, 571, mkChar("n_EaA"));
  SET_STRING_ELT(nms, 572, mkChar("n_EsI"));
  SET_STRING_ELT(nms, 573, mkChar("n_H"));
  SET_STRING_ELT(nms, 574, mkChar("n_HD"));
  SET_STRING_ELT(nms, 575, mkChar("n_HR"));
  SET_STRING_ELT(nms, 576, mkChar("n_I"));
  SET_STRING_ELT(nms, 577, mkChar("n_ICU_D"));
  SET_STRING_ELT(nms, 578, mkChar("n_ICU_HR"));
  SET_STRING_ELT(nms, 579, mkChar("n_ICU_P"));
  SET_STRING_ELT(nms, 580, mkChar("n_ICU_R"));
  SET_STRING_ELT(nms, 581, mkChar("n_ICU_RP"));
  SET_STRING_ELT(nms, 582, mkChar("n_ID"));
  SET_STRING_ELT(nms, 583, mkChar("n_IH"));
  SET_STRING_ELT(nms, 584, mkChar("n_IICU"));
  SET_STRING_ELT(nms, 585, mkChar("n_IR"));
  SET_STRING_ELT(nms, 586, mkChar("n_PI"));
  SET_STRING_ELT(nms, 587, mkChar("n_RS"));
  SET_STRING_ELT(nms, 588, mkChar("n_SE"));
  SET_STRING_ELT(nms, 589, mkChar("n_SE_tot"));
  SET_STRING_ELT(nms, 590, mkChar("n_SEa"));
  SET_STRING_ELT(nms, 591, mkChar("n_SEi"));
  SET_STRING_ELT(nms, 592, mkChar("n_strain"));
  SET_STRING_ELT(nms, 593, mkChar("n_vac"));
  SET_STRING_ELT(nms, 594, mkChar("n_vac_help"));
  SET_STRING_ELT(nms, 595, mkChar("n_vac_now"));
  SET_STRING_ELT(nms, 596, mkChar("offset_output_N"));
  SET_STRING_ELT(nms, 597, mkChar("offset_output_beta_spont_behaviour"));
  SET_STRING_ELT(nms, 598, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 599, mkChar("offset_variable_B_D"));
  SET_STRING_ELT(nms, 600, mkChar("offset_variable_B_D_H"));
  SET_STRING_ELT(nms, 601, mkChar("offset_variable_B_D_ICU"));
  SET_STRING_ELT(nms, 602, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 603, mkChar("offset_variable_Ea"));
  SET_STRING_ELT(nms, 604, mkChar("offset_variable_Es"));
  SET_STRING_ELT(nms, 605, mkChar("offset_variable_H"));
  SET_STRING_ELT(nms, 606, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 607, mkChar("offset_variable_ICU_H"));
  SET_STRING_ELT(nms, 608, mkChar("offset_variable_ICU_P"));
  SET_STRING_ELT(nms, 609, mkChar("offset_variable_ICU_R"));
  SET_STRING_ELT(nms, 610, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 611, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 612, mkChar("offset_variable_tot_hosp"));
  SET_STRING_ELT(nms, 613, mkChar("offset_variable_tot_infected"));
  SET_STRING_ELT(nms, 614, mkChar("offset_variable_tot_resp"));
  SET_STRING_ELT(nms, 615, mkChar("offset_variable_tot_vac"));
  SET_STRING_ELT(nms, 616, mkChar("offset_variable_tot_vac_adm"));
  SET_STRING_ELT(nms, 617, mkChar("p_SE"));
  SET_STRING_ELT(nms, 618, mkChar("pa"));
  SET_STRING_ELT(nms, 619, mkChar("post_icu"));
  SET_STRING_ELT(nms, 620, mkChar("pre_icu"));
  SET_STRING_ELT(nms, 621, mkChar("pre_sympt_infect"));
  SET_STRING_ELT(nms, 622, mkChar("pre_sympt_period"));
  SET_STRING_ELT(nms, 623, mkChar("prob_death_hosp"));
  SET_STRING_ELT(nms, 624, mkChar("prob_death_icu"));
  SET_STRING_ELT(nms, 625, mkChar("prob_death_non_hosp"));
  SET_STRING_ELT(nms, 626, mkChar("rand_beta_days"));
  SET_STRING_ELT(nms, 627, mkChar("spont_behav_change_params"));
  SET_STRING_ELT(nms, 628, mkChar("susceptibility_asymp"));
  SET_STRING_ELT(nms, 629, mkChar("susceptibility_symp"));
  SET_STRING_ELT(nms, 630, mkChar("symp_asymp_effect"));
  SET_STRING_ELT(nms, 631, mkChar("symp_trans"));
  SET_STRING_ELT(nms, 632, mkChar("sympt_frac"));
  SET_STRING_ELT(nms, 633, mkChar("threshold_ini"));
  SET_STRING_ELT(nms, 634, mkChar("threshold_max"));
  SET_STRING_ELT(nms, 635, mkChar("threshold_min"));
  SET_STRING_ELT(nms, 636, mkChar("time_before_death"));
  SET_STRING_ELT(nms, 637, mkChar("time_before_death_hosp"));
  SET_STRING_ELT(nms, 638, mkChar("time_before_death_icu"));
  SET_STRING_ELT(nms, 639, mkChar("tot_hosp_ini"));
  SET_STRING_ELT(nms, 640, mkChar("tot_infected_ini"));
  SET_STRING_ELT(nms, 641, mkChar("tot_resp_ini"));
  SET_STRING_ELT(nms, 642, mkChar("tot_vac_adm_ini"));
  SET_STRING_ELT(nms, 643, mkChar("tot_vac_ini"));
  SET_STRING_ELT(nms, 644, mkChar("transmisibility"));
  SET_STRING_ELT(nms, 645, mkChar("vac_struct_length"));
  SET_STRING_ELT(nms, 646, mkChar("vaccinations"));
  SET_STRING_ELT(nms, 647, mkChar("vax_time_step"));
  SET_STRING_ELT(nms, 648, mkChar("vax_type"));
  SET_STRING_ELT(nms, 649, mkChar("waning_immunity"));
  SET_STRING_ELT(nms, 650, mkChar("waning_immunity_vax"));
  SET_STRING_ELT(nms, 651, mkChar("waning_inf"));
  SET_STRING_ELT(nms, 652, mkChar("waning_tmp"));
...
SEXP model_deterministic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_N = internal->dim_beta_spont_behaviour + internal->dim_contact_change + 1;
  internal->offset_output_beta_spont_behaviour = internal->dim_contact_change + 1;
  internal->offset_variable_A = internal->dim_Ea + internal->dim_Es + internal->dim_I + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_B_D = internal->dim_A + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_B_D_H = internal->dim_A + internal->dim_B_D + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_B_D_ICU = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_D = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_R + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_Ea = internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_Es = internal->dim_Ea + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_H = internal->dim_A + internal->dim_Ea + internal->dim_Es + internal->dim_I + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_I = internal->dim_Ea + internal->dim_Es + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_ICU_H = internal->dim_A + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_ICU_P = internal->dim_A + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_R + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_ICU_R = internal->dim_A + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_P = internal->dim_Ea + internal->dim_Es + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_R = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_tot_hosp = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_D + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_R + internal->dim_S + internal->dim_tot_infected + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_tot_infected = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_D + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_R + internal->dim_S + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_tot_resp = internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_D + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_R + internal->dim_S + internal->dim_tot_hosp + internal->dim_tot_infected + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1;
  internal->offset_variable_tot_vac = internal->dim_S + 1;
  internal->offset_variable_tot_vac_adm = internal->dim_S + internal->dim_tot_vac + 1;
  ...
  cinterpolate_free(internal->interpolate_beta_int);
  internal->interpolate_beta_int = cinterpolate_alloc("spline", internal->dim_interpolation_time, internal->dim_beta_int, internal->interpolation_time, internal->beta_day, true, false);
...
SEXP model_deterministic_metadata(SEXP internal_p) {
  ...
  int * dim_tot_vac = INTEGER(VECTOR_ELT(variable_length, 2));
  ...
  int * dim_tot_vac_adm = INTEGER(VECTOR_ELT(variable_length, 3));
  ...
  int * dim_Ea = INTEGER(VECTOR_ELT(variable_length, 4));
  ...
  int * dim_Es = INTEGER(VECTOR_ELT(variable_length, 5));
  ...
  int * dim_P = INTEGER(VECTOR_ELT(variable_length, 6));
  ...
  int * dim_I = INTEGER(VECTOR_ELT(variable_length, 7));
  ...
  int * dim_A = INTEGER(VECTOR_ELT(variable_length, 8));
  ...
  int * dim_H = INTEGER(VECTOR_ELT(variable_length, 9));
  ...
  int * dim_ICU_H = INTEGER(VECTOR_ELT(variable_length, 10));
  ...
  int * dim_ICU_R = INTEGER(VECTOR_ELT(variable_length, 11));
  ...
  int * dim_ICU_P = INTEGER(VECTOR_ELT(variable_length, 12));
  ...
  int * dim_B_D = INTEGER(VECTOR_ELT(variable_length, 13));
  ...
  int * dim_B_D_H = INTEGER(VECTOR_ELT(variable_length, 14));
  ...
  int * dim_B_D_ICU = INTEGER(VECTOR_ELT(variable_length, 15));
  ...
  int * dim_R = INTEGER(VECTOR_ELT(variable_length, 16));
  ...
  int * dim_D = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_tot_infected = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  int * dim_tot_hosp = INTEGER(VECTOR_ELT(variable_length, 19));
  ...
  int * dim_tot_resp = INTEGER(VECTOR_ELT(variable_length, 20));
  ...
  SET_STRING_ELT(variable_names, 2, mkChar("tot_vac"));
  SET_STRING_ELT(variable_names, 3, mkChar("tot_vac_adm"));
  SET_STRING_ELT(variable_names, 4, mkChar("Ea"));
  SET_STRING_ELT(variable_names, 5, mkChar("Es"));
  SET_STRING_ELT(variable_names, 6, mkChar("P"));
  SET_STRING_ELT(variable_names, 7, mkChar("I"));
  SET_STRING_ELT(variable_names, 8, mkChar("A"));
  SET_STRING_ELT(variable_names, 9, mkChar("H"));
  SET_STRING_ELT(variable_names, 10, mkChar("ICU_H"));
  SET_STRING_ELT(variable_names, 11, mkChar("ICU_R"));
  SET_STRING_ELT(variable_names, 12, mkChar("ICU_P"));
  SET_STRING_ELT(variable_names, 13, mkChar("B_D"));
  SET_STRING_ELT(variable_names, 14, mkChar("B_D_H"));
  SET_STRING_ELT(variable_names, 15, mkChar("B_D_ICU"));
  SET_STRING_ELT(variable_names, 16, mkChar("R"));
  SET_STRING_ELT(variable_names, 17, mkChar("D"));
  SET_STRING_ELT(variable_names, 18, mkChar("tot_infected"));
  SET_STRING_ELT(variable_names, 19, mkChar("tot_hosp"));
  SET_STRING_ELT(variable_names, 20, mkChar("tot_resp"));
  ...
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_N + internal->dim_beta_spont_behaviour + internal->dim_contact_change + 1));
...
SEXP model_deterministic_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  model_deterministic_internal *internal = model_deterministic_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_A + internal->dim_B_D + internal->dim_B_D_H + internal->dim_B_D_ICU + internal->dim_D + internal->dim_Ea + internal->dim_Es + internal->dim_H + internal->dim_I + internal->dim_ICU_H + internal->dim_ICU_P + internal->dim_ICU_R + internal->dim_P + internal->dim_R + internal->dim_S + internal->dim_tot_hosp + internal->dim_tot_infected + internal->dim_tot_resp + internal->dim_tot_vac + internal->dim_tot_vac_adm + 1));
...
void model_deterministic_rhs(model_deterministic_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_kernel_1; ++i) {
    for (int j = 1; j <= internal->dim_kernel_2; ++j) {
      internal->kernel[i - 1 + internal->dim_kernel_1 * (j - 1)] = internal->spont_behav_change_params[3] * ((1 - pow((1 - odin_sum3(internal->p_SE, i - 1, i, j - 1, j, 0, internal->dim_p_SE_3, internal->dim_p_SE_1, internal->dim_p_SE_12)), internal->spont_behav_change_params[1])) * internal->expected_health_loss[internal->dim_expected_health_loss_1 * (j - 1) + i - 1] - internal->spont_behav_change_params[1] * internal->spont_behav_change_params[2]);
    }
  }
  ...
  for (int i = 1; i <= internal->dim_contact_change_1; ++i) {
    for (int j = 1; j <= internal->dim_contact_change_2; ++j) {
      internal->contact_change[i - 1 + internal->dim_contact_change_1 * (j - 1)] = (internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1] > 15 ? 1 : (exp(internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1]) / (double) (1 + exp(internal->kernel[internal->dim_kernel_1 * (j - 1) + i - 1]))));
    }
  }
  for (int i = 1; i <= internal->dim_R_1; ++i) {
    for (int j = 1; j <= internal->dim_R_2; ++j) {
...
SEXP model_deterministic_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  model_deterministic_internal *internal = model_deterministic_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_N + internal->dim_beta_spont_behaviour + internal->dim_contact_change + 1));
